      ...
      <div className="sticky top-0 z-50 border-b border-white/10 bg-slate-900/95 px-4 py-3 text-white backdrop-blur md:px-10">
        <div className="mx-auto flex max-w-6xl items-center justify-between text-sm">
          ...
          <div className="flex gap-2">
            <Link href="/notes/mole-concept/part4" className="rounded-full bg-slate-800 px-3 py-1 text-xs font-bold text-slate-300 hover:bg-slate-700">
              ← Gram Atomic Mass
            </Link>
            <span className="rounded-full bg-cyan-500/20 px-3 py-1 text-xs font-bold text-cyan-300">Molecular Mass</span>
            <Link href="/notes/mole-concept/part6" className="rounded-full bg-slate-800 px-3 py-1 text-xs font-bold text-lime-300 hover:bg-slate-700">
              Next: Formula Units →
            </Link>
          </div>
        </div>
