...
import ThermodynamicsPart23LocalhostReview from "../_components/ThermodynamicsPart23LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 23 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 23.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart23LocalhostReview />
