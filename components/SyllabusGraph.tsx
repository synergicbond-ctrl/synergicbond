...
export default function SyllabusGraph() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-8 rounded-lg border border-slate-100 dark:border-slate-800 shadow-sm space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 py-6">
        {graphNodes.map((node) => (
          <button
            ...
            className={`px-6 py-4 rounded-lg font-extrabold border-2 text-sm transition-all shadow-sm w-full md:w-64 text-center ${
      ...
      {activeCategory && (
        <div className="p-6 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg animate-fadeIn space-y-3">
