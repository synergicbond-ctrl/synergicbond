  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <div className="mx-auto max-w-5xl space-y-6 px-4 py-10 md:px-8">
        ...
        <section className="border-t border-[var(--border)] py-10 md:py-12">
          <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-fuchsia-300">Part 27 Complete</p>
          <h2 className="mt-2 text-2xl font-semibold text-[var(--foreground)]">Next: Gibbs energy of mixing and ideal solutions</h2>
        </section>
      </div>
    </main>
  );
