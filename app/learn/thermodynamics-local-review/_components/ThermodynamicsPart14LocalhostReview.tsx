    ...
    <div className="overflow-x-auto rounded-lg border border-[var(--border)]">
      <table className="min-w-full border-collapse text-left text-sm">
        <thead className="bg-[var(--surface-2)]">
          <tr>
            <th className="px-4 py-3 font-semibold text-[var(--foreground)]">Engine type</th>
            <th className="px-4 py-3 font-semibold text-[var(--foreground)]">Key features</th>
            <th className="px-4 py-3 font-semibold text-[var(--foreground)]">Efficiency</th>
        ...
        <tbody className="divide-y divide-[var(--border)] bg-[var(--surface)]">
          {rows.map(([type, feature, efficiency, meaning]) => (
            <tr key={type}>
              ...
              <td className="px-4 py-3 text-[var(--text-muted)]">{feature}</td>
