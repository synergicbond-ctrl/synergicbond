...
import ThermodynamicsPart16LocalhostReview from "../_components/ThermodynamicsPart16LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 16 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 16.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart16LocalhostReview />
