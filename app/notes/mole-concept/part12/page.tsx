      ...
      <div className="sticky top-0 z-50 border-b border-white/10 bg-slate-900/95 px-4 py-3 text-white backdrop-blur md:px-10">
        <div className="mx-auto flex max-w-6xl items-center justify-between text-sm">
          ...
          <div className="flex gap-2">
            <Link href="/notes/mole-concept/part11" className="rounded-full bg-slate-800 px-3 py-1 text-xs font-bold text-slate-300 hover:bg-slate-700">
              ← Gas &amp; Vapour Density
            </Link>
            <span className="rounded-full bg-lime-500/20 px-3 py-1 text-xs font-bold text-lime-300">Isotopes &amp; Atomic Mass</span>
            <Link href="/notes/mole-concept/part13" className="rounded-full bg-slate-800 px-3 py-1 text-xs font-bold text-cyan-300 hover:bg-slate-700">
              Next: Gas Mixtures →
            </Link>
          </div>
        </div>
