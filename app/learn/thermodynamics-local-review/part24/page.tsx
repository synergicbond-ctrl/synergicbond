...
import ThermodynamicsPart24LocalhostReview from "../_components/ThermodynamicsPart24LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 24 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 24.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart24LocalhostReview />
