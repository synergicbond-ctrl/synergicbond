...
import ThermodynamicsPart03LocalhostReview from "../_components/ThermodynamicsPart03LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 03 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 03.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart03LocalhostReview />
