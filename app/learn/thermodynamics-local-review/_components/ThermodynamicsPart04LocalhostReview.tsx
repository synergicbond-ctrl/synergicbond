  ...
  return (
    <article className={`rounded-lg border p-5 ${toneMap[tone]}`}>
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em]">{graph}</p>
          <h3 className="mt-2 font-display text-xl font-semibold text-[var(--foreground)]">{name}</h3>
        </div>
        <div className="rounded-xl bg-[var(--surface-2)] px-3 py-2 font-mono text-sm font-semibold text-[var(--foreground)]">
          {invariant}
        </div>
      </div>

      <div className="mt-4 rounded-xl bg-[var(--surface-2)] p-3 font-mono text-center text-sm font-black text-[var(--foreground)]">
        {differential}
      </div>
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-2">
      <article className="rounded-lg border border-cyan-300/20 bg-cyan-300/[0.05] p-5">
        <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-cyan-300">Isothermal control</p>
      ...
      <article className="rounded-lg border border-emerald-300/20 bg-emerald-300/[0.05] p-5">
        <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-emerald-300">Adiabatic isolation</p>
      ...
      {cards.map((card) => (
        <article key={card.title} className={`rounded-lg border p-5 ${toneMap[card.tone]}`}>
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em]">{card.criterion}</p>
              <h3 className="mt-2 font-display text-xl font-semibold text-[var(--foreground)]">{card.title}</h3>
            </div>
            <span className="rounded-xl bg-[var(--surface-2)] px-3 py-2 font-mono font-semibold text-[var(--foreground)]">{card.symbol}</span>
          </div>
      ...
      <table className="min-w-full border-collapse text-left text-sm">
        <thead className="bg-[var(--surface-2)]">
          <tr>
            ...
            <th className="px-4 py-3 font-semibold text-[var(--foreground)]">Scientifically correct form</th>
          </tr>
        </thead>
            ...
            <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6">
              ...
              <div className="mt-4 space-y-3">
                {[
                  ...
                  <div key={title} className="rounded-xl bg-[var(--surface-2)] p-4">
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-5 py-9 md:px-8 md:py-12">
        ...
        <Section index="03" title="Adiabatic process">
          ...
          <div className="rounded-lg border border-[var(--border)] bg-[var(--surface)] p-5">
            <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-cyan-300">Preview relation</p>
            <p className="mt-3 font-mono font-display text-xl font-semibold text-[var(--foreground)]">PV<sup>γ</sup> = constant</p>
        ...
        >
          <div className="grid gap-4 lg:grid-cols-3">
            <article className="rounded-lg border border-cyan-300/20 bg-cyan-300/[0.05] p-5">
              <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-cyan-300">P–V plane</p>
            ...
            <article className="rounded-lg border border-amber-300/20 bg-amber-300/[0.05] p-5">
              <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-amber-300">T–V plane</p>
              <p className="mt-2 text-sm leading-6 text-[var(--text-body)]">
            ...
            <article className="rounded-lg border border-violet-300/20 bg-violet-300/[0.05] p-5">
              <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-violet-300">P–T plane</p>
              <p className="mt-2 text-sm leading-6 text-[var(--text-body)]">
