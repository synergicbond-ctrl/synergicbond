      ...
      <article className="mx-auto max-w-5xl space-y-10">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="overflow-x-auto py-3 bg-[var(--background)] rounded-2xl border border-[var(--border)] px-4 space-y-2">
              ...
              <div className="border-t border-[var(--border)] pt-2 text-center text-cyan-300 font-bold">
            ...
            <div className="grid gap-6 md:grid-cols-2 pt-2 text-xs font-mono">
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2">
                ...
                <div className="mt-2 text-cyan-300 border-t border-[var(--border)] pt-2 space-y-1">
              ...
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2">
                ...
                <div className="mt-2 text-emerald-300 border-t border-[var(--border)] pt-2 space-y-1">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="overflow-x-auto py-3 bg-[var(--background)] rounded-2xl border border-[var(--border)] px-4 text-center">
