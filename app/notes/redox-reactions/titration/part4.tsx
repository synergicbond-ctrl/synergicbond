...
<PageCard title="Mixed Oxalate Compound — KMnO₄ and NaOH Titration">
          <div className="space-y-4 rounded-lg border border-violet-500/20 bg-violet-950/20 text-violet-200 p-4">
          ...
          <div className="mt-6 space-y-4 rounded-lg border border-rose-500/20 bg-rose-950/20 text-rose-200 p-4">
            <QuestionBox>
        ...
        <PageCard title="KMnO₄–H₂O₂ Dilution, Mixed Acid-Base and Metal Equivalent Weight">
          ...
          <div className="mt-6 space-y-4 rounded-lg border border-blue-500/20 bg-blue-950/20 text-blue-200 p-4">
            <QuestionBox>
          ...
          <div className="mt-6 space-y-4 rounded-lg border border-red-500/20 bg-red-950/20 text-red-200 p-4">
            <QuestionBox>
