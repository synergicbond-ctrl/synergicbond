      ...
      <div className="sticky top-0 z-50 border-b border-white/10 bg-slate-900/95 px-4 py-3 text-white backdrop-blur md:px-10">
        <div className="mx-auto flex max-w-6xl items-center justify-between text-sm">
          ...
          <div className="flex gap-2">
            <Link href="/notes/mole-concept/part5" className="rounded-full bg-slate-800 px-3 py-1 text-xs font-bold text-slate-300 hover:bg-slate-700">
              ← Molecular Mass
            </Link>
            <span className="rounded-full bg-lime-500/20 px-3 py-1 text-xs font-bold text-lime-300">Formula Units &amp; Hydrates</span>
            <Link href="/notes/mole-concept/part7" className="rounded-full bg-slate-800 px-3 py-1 text-xs font-bold text-cyan-300 hover:bg-slate-700">
              Next: Ionic Charge →
            </Link>
          </div>
        </div>
