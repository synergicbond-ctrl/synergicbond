...
const ConceptCard = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="my-6 rounded-2xl border border-emerald-400/30 bg-[var(--surface)]/90 p-6 shadow-xl">
            ...
            steps={
              <div className="space-y-4">
                ...
                <StepBox number={2} title="Calculate Oxygen Consumption &amp; CO₂ Production for Each Component">
                  <div className="space-y-2 border-l-2 border-[var(--border-strong)] pl-3">
                    <div>
