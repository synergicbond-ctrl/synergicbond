...
const markdownComponents: Components = {
  ...
  p: ({ children }) => <p className="max-w-[92ch] text-[15.5px] leading-[1.85] text-[var(--text-body)] sm:text-[16.5px]">{children}</p>,
  ul: ({ children }) => <ul className="ml-5 max-w-[92ch] list-disc space-y-2.5 text-[var(--text-body)] marker:text-cyan-300">{children}</ul>,
  ol: ({ children }) => <ol className="ml-6 max-w-[92ch] list-decimal space-y-2.5 text-[var(--text-body)] marker:font-black marker:text-amber-300">{children}</ol>,
