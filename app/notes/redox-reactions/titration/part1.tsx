            ...
            <DiagramBox title="Burette setup">
              <div className="mx-auto grid max-w-md gap-4 md:grid-cols-[80px_1fr]">
                <div className="relative mx-auto h-72 w-12 rounded-full border-4 border-blue-500/30 bg-slate-950/40">
                  <div className="absolute left-full top-4 ml-3 whitespace-nowrap rounded-full bg-[rgba(251,191,36,0.10)] px-3 py-1 text-sm font-bold text-amber-200">
                    75.0 ml
                  </div>
                  <div className="absolute left-full top-28 ml-3 whitespace-nowrap rounded-full bg-[rgba(251,191,36,0.10)] px-3 py-1 text-sm font-bold text-amber-200">
                    40.0 ml
                  </div>
                  <div className="absolute left-0 top-28 h-1 w-full bg-orange-500" />
                  <div className="absolute bottom-0 left-1/2 h-10 w-2 -translate-x-1/2 bg-cyan-400" />
                </div>
