  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-[var(--text-muted)]">Dichlorobenzene literature values are widely reproduced with minor variation (illustrative rounded figures: ortho≈2.0, meta≈1.5, para≈0), but every reported set shows the same correct qualitative order ortho &gt; meta &gt; para → 0; small numeric differences reflect different measurement/rounding conventions and are not chemically significant.</p>
