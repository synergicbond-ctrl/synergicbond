...
export default function DBlockPart06() {
  return (
    <AppShell
      ...
      chapterSlug="d-block"
      description="A mechanism-first treatment of visible absorption, ligand-field splitting, selection rules, charge transfer, silver-halide polarisation, aquated-ion colours, spin-only moments and cooperative magnetic order."
      free={false}
