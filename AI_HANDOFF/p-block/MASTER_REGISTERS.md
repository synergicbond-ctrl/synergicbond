...
## A. Topic Register — Group 15 (from pp. 448–470)

| # | Topic | Status |
|---|---|---|
| A1 | Nitrogen's full oxidation-state ladder −III → +V with a named compound at each step | **NEW** |
| A2 | Why N₂ is inert but isoelectronic CO, CN⁻, NO⁺ are reactive (bond polarity) | **NEW** |
| A3 | **Active nitrogen** — atomic N from low-pressure discharge, yellow–pink afterglow | **NEW** |
| A4 | P₄ ⇌ 2P₂ above 800 °C; P₂ bond energy exactly half N₂'s, from poor 3p–3p overlap | **NEW** |
| A5 | Black phosphorus corrugated layer structure | partial |
| A6 | Sb³⁺ and Bi³⁺ genuinely exist; SbF₃ and BiF₃ ionic; hydrolysis to SbO⁺/BiO⁺ reversed by 5 M HCl | **NEW** |
| A7 | N³⁻ costs 2125 kJ mol⁻¹ → only Li₃N, Be₃N₂, Mg₃N₂, Ca₃N₂ ionic; Na₃P, Na₃Bi **not** ionic | **NEW** |
| A8 | d-orbital contraction under electronegative ligands — the real basis of "sp³d" | **NEW** |
| A9 | Why N₂O₃/N₂O₅ are monomeric while heavier trioxides/pentoxides dimerise | **NEW** |
| A10 | Electrical resistivity ladder proving increasing metallic character | **NEW** |
| A11 | Five-point hydride gradation incl. donor power and ease of H-substitution | partial |
| A12 | Ammonium-salt thermal decomposition split by whether the anion is oxidising | **NEW** |
| A13 | NH₃ solubility as 702 volumes per volume of water | **NEW** |
| A14 | Four detection tests for NH₃ incl. **Nessler's solution** | **NEW** |
| A15 | Individual ammonium salts: NH₄Cl, NH₄NO₃, (NH₄)₂SO₄, (NH₄)₂HPO₄, NH₄H₂PO₄, NH₄ClO₄ | **NEW** |
| A16 | **Hydrazine** — full treatment | **NEW** |
| A17 | **Hydroxylamine** — full treatment incl. nylon-6 route | **NEW** |
| A18 | **Liquid ammonia as a solvent** — self-ionisation, reversed precipitations, levelling | **NEW** |
| A19 | **Hydrogen azide and the azides** | **NEW** |
| A20 | **Nitrogen fixation** — biological and industrial, dinitrogen complexes | **NEW** |
| A21 | **NPK fertilizers**, urea, superphosphate, triple superphosphate | **NEW** |
| A22 | Haber–Bosch in industrial detail incl. feedstock and catalyst poisons | partial |
| A23 | Nitrate pollution: eutrophication, methaemoglobinaemia, ozone | **NEW** |
| A24 | Complete trihalide set and its differentiated hydrolysis | **NEW** |
| A25 | Complete pentahalide set; why no MH₅ exists | partial |
| A26 | **Pseudorotation** in PF₅ — the electron-diffraction/NMR paradox | **NEW** |
| A27 | Six nitrogen oxides incl. NO₃/N₂O₆ | partial |
| A28 | Nitrite as ligand — nitro/nitrito linkage isomerism | **NEW** |
| A29 | Nitrosamine formation and the cured-meat problem | **NEW** |
| A30 | Nitration mechanism via NO₂⁺; TNT, picric acid, nitroglycerine | **NEW** |

## B. Compound Register — Group 15 (pp. 448–470)

Columns: formula · name · family · O.S. · status · destination.

**Hydrides and derivatives**
| Formula | Name | Family | O.S. | Status | Destination |
|---|---|---|---|---|---|
| NH₃ | ammonia | hydride | −III | HAVE, deepen | §8.1 |
| **N₂H₄** | hydrazine | hydride | **−II** | **NEW** | §8 new subsection |
| **NH₂OH** | hydroxylamine | hydride | **−I** | **NEW** | §8 new subsection |
| **P₂H₄** | diphosphine | hydride | −II | **NEW** | §10.2 |
| PH₃ | phosphine | hydride | −III | HAVE | §10.2 |
| **AsH₃** | arsine | hydride | −III | **NEW** | §7.5 |
| **SbH₃** | stibine | hydride | −III | **NEW** | §7.5 |
| **BiH₃** | bismuthine | hydride | −III | **NEW** | §7.5 |
| **N₂H₅⁺, N₂H₆²⁺** | hydrazinium ions | cation | — | **NEW** | §8 |
| **[NH₃OH]⁺** | hydroxylammonium | cation | — | **NEW** | §8 |
| **NH₂Cl** | chloramine | halide-amide | — | **NEW** | §8 (Raschig) |

**Azides**
| **HN₃** | hydrogen azide (hydrazoic acid) | oxoacid-analogue | — | **NEW** | §8 new |
| **N₃⁻** | azide (pseudohalide) | anion | — | **NEW** | §8, §17.3 |
| **NaN₃, LiN₃, Pb(N₃)₂** | metal azides | salt | — | **NEW** | §8 |
| **FN₃, ClN₃, BrN₃, IN₃** | halogen azides | interpseudohalogen | — | **NEW** | §17.3 |
| **cyanuric triazide** | — | explosive | — | **NEW** | §8 |

**Ammonium salts** — NH₄Cl · NH₄NO₃ · NH₄NO₂ · (NH₄)₂SO₄ · (NH₄)₂Cr₂O₇ · (NH₄)₂HPO₄ · NH₄H₂PO₄ · **NH₄ClO₄** · NH₄OH — all **NEW** as individually treated species → §8.1

**Nitrogen oxides** — N₂O · NO · N₂O₃ (**two interconvertible forms**) · NO₂ · N₂O₄ · N₂O₅ · **NO₃/N₂O₆** — HAVE except the last and the N₂O₃ isomers → §8.3

**Nitrogen oxo-anions/cations** — NO₂⁻ · NO₃⁻ · **NO⁺ (nitrosonium)** · **NO₂⁺ (nitronium)** · **[NO]⁺[NO₂]⁻** (solid N₂O₃) · **[NO₂]⁺[NO₃]⁻** (solid N₂O₅) · **NO[ClO₄], NO[HSO₄]** nitrosyl salts → mostly **NEW** → §8.3, §8.4

**Halides** — NF₃ · NCl₃ · **NBr₃·6NH₃** · **NI₃·6NH₃** · PF₃ · PCl₃ · PBr₃ · PI₃ · AsCl₃ · SbCl₃ · **SbF₃** · BiCl₃ · **BiF₃** · PF₅ · PCl₅ · **PBr₅** · **PI₅** · **AsF₅** · **(AsCl₅)** · **SbF₅** · **SbCl₅** · **BiF₅** · **[PCl₄]⁺[PCl₆]⁻** · **[PBr₄]⁺Br⁻** · **[PI₄]⁺I⁻** · **[SbF₅]²⁻, [Sb₂F₇]⁻** · **PHF₄, PH₂F₃** — largely **NEW** → §7.6, §10.3

**Oxyhalides** — **POCl₃** · **NOCl** · **NO₂F** · **NO₂Cl** · **SOCl₂** (via PCl₅ + SO₂) → **NEW** → §10.3

**Phosphazenes** — **(NPCl₂)ₙ** rings n = 3–8; **Cl₄P·(NPCl₂)ₙ·NPCl₃** chains → **NEW** → §10.3

**Nitrides/phosphides** — Li₃N · Be₃N₂ · Mg₃N₂ · Ca₃N₂ · Na₃P · Na₃Bi · Ca₃P₂ · **Zn₃As₂** · **Mg₃Sb₂** · **Mg₃Bi₂** · **Cu₃P₂** · **Hg₃P₂** · **Ag₃P·3AgNO₃** → mostly **NEW** → §7.8, §10.2

**Industrial/fertilizer** — **CaNCN** calcium cyanamide · **urea CO(NH₂)₂** · **NH₂COONH₄** ammonium carbamate · **Ca(H₂PO₄)₂** superphosphate · **fluoroapatite** · **basic slag** · **K₂SO₄** → **NEW** → §7.7, new NPK subsection

**Complexes** — **[Ru(NH₃)₅(N₂)]²⁺** · [Co(NH₃)₆]³⁺ · **[Fe(H₂O)₅NO]²⁺** brown-ring · **Na₂[Fe(CN)₅NO]** nitroprusside · **[Fe(CO)₂(NO)₂]** · **[Cr(NO)₄]** · **Ni(PF₃)₄** · **[F₃B←PH₃]** · **[Cl₃Al←PH₃]** · **[Cr(CO)₃(PH₃)₃]** · **K₃[Co(NO₂)₆]** · **[Co(NH₃)₅(NO₂)]²⁺ / [Co(NH₃)₅(ONO)]²⁺** · **[Ti(OR)₂N₂]** → all **NEW** → §8, §10

**Organophosphorus** — **(EtO)₃PO** triethyl phosphate · **tritolyl phosphate** · trioctyl phosphate → **NEW** → §10.3

## C. Reaction Register — Group 15 (pp. 448–470)

Grouped by reaction class. All balanced as printed unless flagged.

**Hydrolysis (differentiated by element — a single table replaces four facts)**
- NCl₃ + 4H₂O → NH₄OH + 3HOCl **(note: N is the *positive* end, so N goes to NH₃ not HOCl)**
- PCl₃ + 3H₂O → H₃PO₃ + 3HCl · AsCl₃ + 3H₂O → H₃AsO₃ + 3HCl
- SbCl₃ + H₂O → SbO⁺ + 3Cl⁻ + 2H⁺ · BiCl₃ + H₂O → BiO⁺ + 3Cl⁻ + 2H⁺
- **NF₃ does not hydrolyse at all** (cf. CF₄) — reacts only if sparked with water vapour
- PCl₅ + 4H₂O → H₃PO₄ + 5HCl; **equimolar** → POCl₃ + 2HCl
- CaNCN + 5H₂O → CaCO₃ + 2NH₄OH
- NH₂CONH₂ + 2H₂O → (NH₄)₂CO₃
- N₂O₃ + H₂O → 2HNO₂ · N₂O₄ + H₂O → HNO₃ + HNO₂ · N₂O₅ + H₂O → 2HNO₃

**Thermal decomposition (anion-dependent)**
- NH₄Cl → NH₃ + HCl · (NH₄)₂SO₄ → 2NH₃ + H₂SO₄
- NH₄NO₂ → N₂ + 2H₂O · NH₄NO₃ (280 °C) → N₂O + 2H₂O · **2NH₄NO₃ (>300 °C) → 2N₂ + O₂ + 4H₂O**
- (NH₄)₂Cr₂O₇ → N₂ + 4H₂O + Cr₂O₃
- 2NaNO₃ → 2NaNO₂ + O₂ · NaNO₃ + Pb → NaNO₂ + PbO
- 2Pb(NO₃)₂ → 2PbO + 4NO₂ + O₂
- 2HN₃ → H₂ + 3N₂ (explosive)

**Disproportionation**
- 4[NH₂OH·H]⁺ → N₂O + 2NH₄⁺ + 2H⁺ + 3H₂O (slow, acid)
- 3NH₂OH → N₂ + NH₃ + 3H₂O (rapid, alkaline)
- 2HNO₂ → NO₂ + NO + H₂O
- P₄ + 3NaOH + 3H₂O → PH₃ + 3NaH₂PO₂

**Redox — hydrazine**
- N₂H₄ + O₂ → N₂ + 2H₂O, ΔH = −621 kJ mol⁻¹
- N₂H₄ + 2I₂ → 4HI + N₂ · N₂H₄ + 2O₂ → 2H₂O₂ + N₂ · N₂H₄ + 2CuSO₄ → Cu + N₂ + 2H₂SO₄
- **N₂H₄ + Zn + 2HCl → 2NH₃ + ZnCl₂** (hydrazine *reduced*, i.e. oxidised partner)

**Raschig synthesis (with both side reactions)**
- NH₃ + NaOCl → NH₂Cl + NaOH (fast); 2NH₃ + NH₂Cl → N₂H₄ + NH₄Cl (slow)
- side: N₂H₄ + 2NH₂Cl → N₂ + 2NH₄Cl; 3NH₂Cl + 2NH₃ → N₂ + 3NH₄Cl

**Azide synthesis**
- N₂O + 2NaNH₂ → NaN₃ + NH₃ + NaOH (190 °C, anhydrous)
- 6HN₃ + 4Li → 4LiN₃ + 2NH₃ + 2N₂ **(no H₂ evolved — unlike any normal acid + metal)**
- NaN₃ + H₂S + H₂O → NH₃ + N₂ + S + NaOH (analysis)

**Complex formation**
- [Ru(NH₃)₅H₂O]²⁺ + N₂ → [Ru(NH₃)₅N₂]²⁺ (first dinitrogen complex, 1965)
- Ni(CO)₄ + 4PF₃ → Ni(PF₃)₄ + 4CO
- [Fe(CO)₅] + 2NO → [Fe(CO)₂(NO)₂] + 3CO **(NO is a 3-electron donor — 2 NO replace 3 CO)**
- [Cr(CO)₆] + 4NO → [Cr(NO)₄] + 6CO

**Industrial**
- CaC₂ + N₂ → CaNCN + C (1100 °C)
- 2NH₃ + CO₂ → NH₂COONH₄ → CO(NH₂)₂ + H₂O (180–200 °C, high P)
- 3Ca₃(PO₄)₂·CaF₂ + 7H₂SO₄ → 3Ca(H₂PO₄)₂ + 7CaSO₄ + 2HF
- 3Ca₃(PO₄)₂·CaF₂ + 14H₃PO₄ → 10Ca(H₂PO₄)₂ + 2HF
- 2NH₃ + CO₂ + H₂O → (NH₄)₂CO₃; + CaSO₄ → CaCO₃ + (NH₄)₂SO₄

**Nitryl/nitrosyl halide formation**
- 2NO₂ + F₂ → 2NO₂F · 2NO₂ + Cl₂ → 2NO₂Cl · 2NO + Cl₂ → 2NOCl
- 2NO₂ + 4HCl → 2NOCl + Cl₂ + 2H₂O · NO₂ + CO → CO₂ + NO
- N₂O₃ + 2HClO₄ → 2NO[ClO₄] + H₂O
- N₂O₅ + NaCl → NaNO₃ + NO₂Cl

## D. Structure Register — Group 15 (pp. 448–470)

| Species | Structure | Numerical data |
|---|---|---|
| N₂ | triple bond | 1.09 Å; D = 945.4 kJ mol⁻¹ |
| P₂ | pπ–pπ, poor overlap | D = 489.6 kJ mol⁻¹ |
| NH₃ | pyramidal | ∠107°48′, N–H 1.017 Å, D 389 |
| PH₃ / AsH₃ / SbH₃ | pyramidal, near-pure p | ∠93°36′ / 91°48′ / 91°18′ |
| NH₄⁺ | tetrahedral | — |
| **N₂H₄** | ethane-like, **gauche, rotated 95°** | N–N 1.45 Å |
| **NH₂OH** | — | — |
| **N₃⁻** | **linear, isoelectronic with CO₂** | both N–N 1.16 Å, order 2 |
| **HN₃** | **bent, unequal N–N** | ∠H–N–N 112°; orders ≈1.5 and 2 |
| **NF₃** | pyramidal | ∠102°30′; **µ = 0.23 D vs 1.47 D for NH₃** |
| **PF₅** | trigonal bipyramidal, **pseudorotating** | axial 1.58 Å, equatorial 1.53 Å |
| **PCl₅ solid** | **[PCl₄]⁺ tetrahedral + [PCl₆]⁻ octahedral** | — |
| N₂O | **linear, asymmetric N–N–O** | orders N–N 2.73, N–O 1.61 |
| NO | odd-electron | 1.15 Å; **NO⁺ 1.06 Å** |
| **N₂O₃** | **two photo-interconvertible forms**; solid is [NO]⁺[NO₂]⁻ | N–N **1.864 Å** (very long) |
| NO₂ | angular | ∠132°, N–O 1.20 Å |
| N₂O₄ | planar | **N–N 1.64 Å — anomalously long, unexplained** |
| N₂O₅ | solid **[NO₂]⁺[NO₃]⁻** | — |
| NO₂⁻ | planar triangular, 3-centre bond | order 1.5 |
| NO₃⁻ | planar triangular | contrast tetrahedral PO₄³⁻ |

## E. MO-Theory Register

Where MO theory does real explanatory work (spec Phase 8):

| # | Case | The MO argument |
|---|---|---|
| E1 | **NO** | 11 outer electrons; extra electron in **π\*2p** → bond order 2½; removing it gives NO⁺ with order 3, and the bond **contracts 1.15 → 1.06 Å.** Quantitative confirmation. |
| E2 | **HN₃ vs N₃⁻** | N₃⁻ symmetric, both bonds 1.16 Å. Adding H's electron **forces occupation of an antibonding MO**, so HN₃ has two *different* N–N lengths. |
| E3 | **NO₂ ⇌ N₂O₄** | odd-electron paramagnetic monomer pairing to diamagnetic dimer. |
| E4 | **N₂ vs CO/CN⁻/NO⁺** | isoelectronic but N₂'s bonds are **non-polar**, hence far less reactive. |
| E5 | **O₂ paramagnetism** | already in §11.3. |
| E6 | **d-orbital contraction** | 3d of free P is far too diffuse to bond; **electronegative ligands contract it to 3s/3p size**. This is the honest basis for the "sp³d" label — and the limit of it. |
| E7 | **Donor power of MH₃** | as ∠ → 90°, M–H uses near-pure p, so the lone pair sits in a **spherical s orbital** — larger, less directional, a poor σ donor. Plus 4d/5d too diffuse for π back-bonding. |
| E8 | **NF₃ low dipole** | lone-pair moment **partly cancelled** by three electronegative F; explains weak donor power. |
| E9 | **NO as 3-electron donor** | 2 NO replace 3 CO. |
| E10 | Xenon fluorides | pending §10.73. |

## F. Visual Register

Every diagram the Group 15 harvest demands, tagged with the component that will render it.

| # | Visual | Component |
|---|---|---|
| V1 | Nitrogen oxidation-state ladder −III → +V with a compound at each rung | `OxidationStateMap` |
| V2 | MO diagram of NO showing the π\* electron; NO → NO⁺ contraction | `MODiagram` |
| V3 | N₃⁻ linear vs HN₃ bent, with bond lengths | `MoleculeDiagram` |
| V4 | Hydrazine gauche conformation (95°) | `MoleculeDiagram` |
| V5 | PF₅ pseudorotation (axial ⇌ equatorial) | `ReactionNetwork` / animated `MoleculeDiagram` |
| V6 | PCl₅: gas TBP vs solid [PCl₄]⁺[PCl₆]⁻ | `ComparisonGraphic` |
| V7 | Hydride bond-angle collapse 107°48′ → 91°18′ | `TrendChart` |
| V8 | Trihalide hydrolysis map (N/P/As/Sb/Bi give five different products) | `HydrolysisMap` |
| V9 | Ammonium-salt decomposition decision tree (oxidising anion or not) | `ProcessFlow` |
| V10 | Haber–Bosch flow with feedstock, poisons, recycle loop | `ProcessFlow` |
| V11 | Ostwald flow | `ProcessFlow` |
| V12 | Nitrogen cycle / fixation | `ProcessFlow` |
| V13 | Six nitrogen oxides structure gallery with angles and lengths | `StructureGallery` |
| V14 | Nitro vs nitrito linkage isomerism | `ComparisonGraphic` |
| V15 | Liquid NH₃ vs H₂O solvent-analogy table incl. reversed precipitation | `ComparisonGraphic` |
| V16 | N₂O₃ two forms, colourless ⇌ blue | `ComparisonGraphic` |
| V17 | Superphosphate vs triple superphosphate routes | `ProcessFlow` |

## G. Contradictions and verification queue

| Item | Issue | Action |
|---|---|---|
| NH₃ + H₂O K value | printed as `K = 1.8 × 10⁵` — should be **1.8 × 10⁻⁵** | corrected; do not propagate |
| N₂ dissociation energy | 945.4 here vs 941.4 elsewhere in same book vs 941 in coaching texts | use ≈941; note spread |
| Ostwald conditions | 5 atm/850 °C here vs 9 bar/500 K in coaching sheet | **both recorded — needs NCERT to arbitrate** |
...
# Addendum 14 — file 12 PDF 68–73 (printed 535–540): Group 16 occurrence, extraction and industrial recovery

All six pages `DEEP READ — UNIQUE REGISTERED`. Triage label `FULL — UNIQUE`
confirmed: **file 8 has no Group 16 extraction section at all**, so this whole
range is new. Every printed equation was balance-checked; all balance, and no new
contradiction arises from them.

## A. Dioxygen — manufacture, purity and uses (printed 535–536)

**Manufacture.** Fractional distillation of liquid air. **The commercial gas
carries traces of N₂ and the noble gases, particularly argon** — the same argon
problem already registered for nitrogen (A180), now seen from the oxygen side.

**Laboratory and special routes, all newly registered.**
`2KClO₃ —(150 °C, MnO₂ catalyst)→ 2KCl + 3O₂` — **but the product often contains
traces of Cl₂ or ClO₂**, which is why it is not a route to pure oxygen.
`2HOCl —(Co²⁺)→ 2HCl + O₂` — **catalytic decomposition of hypochlorite**, a route
the registers did not have.
Electrolysis of water with a trace of **H₂SO₄ or barium hydroxide**.
**Emergency breathing oxygen in aircraft is generated by heating NaClO₃** — a
chlorate candle, and a genuinely memorable application.

**Scale and consumption.** World production of liquid and gaseous O₂ **about 100
million tonnes/year**, of which **60–80 % goes to iron and steel**.

**Why steelmaking switched from air to oxygen — three reasons, all given.**
Pure O₂ converts pig iron to steel in the **basic oxygen process**, which began as
the **Kaldo and LD processes** and **replaced the Bessemer process (which used
air) from the late 1950s**. The advantages: **(1)** conversion is quicker;
**(2)** larger charges are possible — **Bessemer 6 tonnes against BOP 100
tonnes**; **(3)** **the metal does not form nitrides**, which happens when air is
used. Reason (3) is the chemical one and the course does not have it.

**Oxygen in the blast furnace.** Introduced with air so that **heavy hydrocarbons
(naphtha)** can partly replace expensive metallurgical coke.

**Four named chemical uses.** Preparing **TiO₂ from TiCl₄** (white pigment in
paint and paper, filler in plastics) · oxidising **NH₃ in HNO₃ manufacture** ·
manufacture of **oxirane (ethylene oxide) from ethene** · **oxidant in rockets**.

**Reactivity.** Practically every element reacts with O₂ at room temperature or on
heating; **the only exceptions are a few noble metals — Pt, Au, W — and the noble
gases**. Despite the **O₂ bond energy of 493 kJ mol⁻¹**, reactions are strongly
exothermic and once started often continue spontaneously.

## B. Sulphur — where it actually comes from (printed 536–538)

**World production 57 million tonnes in 1992.** Producers: **USA 20 %, former
Soviet Union 15 %, Canada 13 %, China 11 %, Japan and former Czechoslovakia 5 %
each.**

**The six extraction routes, with their shares — a table file 8 lacks entirely:**

| Route | Share |
|---|---|
| Recovered from natural gas and petroleum | **48 %** |
| Mined by the **Frasch process** | 19 % |
| From **pyrites** | 17 % |
| Recovered from **smelter gases** | 12 % |
| Mined as sulphur ore | 4 % |
| Made from **CaSO₄** | 0.03 % |

**The headline conclusion:** **more sulphur now comes from gas and petroleum than
is mined by the Frasch process.** Recovery is driven by the need to strip sulphur
compounds out of fuels — H₂S has an objectionable smell, and burning sulphur
compounds gives SO₂, which is acrid and corrosive.

**Canadian natural gas may contain up to 20 % H₂S**, and these plants are **90 %
of Canada's sulphur**. Oil refineries supply **60 % of the USA total and 37 % of
the USSR total**.

**The recovery chemistry (the Claus principle, though not named here).** About a
third of the H₂S is burned and the SO₂ then reacted with the remaining H₂S:
`2H₂S + 3O₂ → 2SO₂ + 2H₂O`, then `SO₂ + 2H₂S → 2H₂O + 3S`.

**Native sulphur deposits and their biological origin.** Found in the **USA (Gulf
of Mexico states — Louisiana, Texas, Mexico)** and the **upper Vistula region of
Poland and Ukraine**. **These deposits were formed by anaerobic bacteria which
metabolise CaSO₄ to H₂S and S.**

**The Frasch process, in full mechanical detail.** **Three concentric pipes** are
sunk in a borehole to the deposit. **Superheated steam down the outer pipe melts
the sulphur; compressed air down the inner pipe forces the molten sulphur up the
middle pipe.** One borehole works **about half an acre**. Developed for **swamp
and quicksand ground and for offshore mining in Louisiana**. Started in the
**USA in the 1890s and in Poland in the 1950s**. **Yields sulphur in very high
purity** — which is the process's real selling point.

**Sulphide-ore route.** SO₂ arises as a by-product of extracting metals from
sulphide ores; **iron pyrites (fool's gold) FeS₂** is the most important, mined in
the USSR, Spain, Portugal and Japan. Wurtzite ZnS, galena PbS, several copper
sulphides and NiS all give SO₂ in smelters, and the SO₂ goes to H₂SO₄. **This route
now yields more sulphur than the other two — but as SO₂, not as S**, which is why
it sits at 12 % in the elemental-sulphur table above and yet dominates by mass.

**Chalcophiles — a term the registers did not have.** **The p-block metals and
about half the transition metals form sulphide minerals, and are collectively
called chalcophiles.**

**Sulphate route.** Vast sulphur as dissolved oceanic sulphate and as CaSO₄, with
smaller FeSO₄ and Al₂(SO₄)₃ deposits. **In Poland SO₂ is made by heating CaSO₄
with coke in a rotary kiln**: `2CaSO₄ + C —(1200 °C)→ 2SO₂ + 2CaO + CO₂`,
**about 20 000 tonnes/year**, feeding the Contact process. Elemental sulphur from
sulphates is **not much used because other sources are cheaper**.

**A source that has disappeared.** Elemental sulphur was once a large by-product
of **coal-gas manufacture**; since natural gas replaced town gas, **this source
has largely vanished except in less developed areas**.

## C. Table 15.3 — sulphide ores, each named individually
...
| FeAsS | Arsenopyrites |
| (Fe,Ni)₉S₈ | Pentlandite |
| Cu₂S | Copper glance / chalcocite |
| CuFeS₂ | Copper pyrites / chalcopyrite |
| Cu₅FeS₄ | Bornite / peacock mineral |
| Ag₂S | Silver glance / argentite |
| **ZnS** | **Zinc blende / sphalerite** |
| **ZnS** | **Wurtzite** |
| HgS | Cinnabar |
| PbS | Galena / lead glance |
| As₂S₃ | Orpiment |
| As₄S₄ | Realgar |
| Sb₂S₃ | Stibnite |
| Bi₂S₃ | Bismuthinite |

**Two formulae appear twice, and that is the teaching point.** **FeS₂ is both
pyrites and marcasite**, and **ZnS is both zinc blende and wurtzite** — same
composition, different mineral, different structure. Polymorphism made concrete,
and the wurtzite/blende pair is already used in the course for the ZnS structure
types. Arsenopyrite, orpiment, realgar, stibnite and bismuthinite were registered
from PDF 4–5 (Addendum 7); **existing IDs kept and expanded with the mineral-table
source page, not re-counted.**

## D. Acid rain — the quantitative version (printed 538)

File 8 carried a short box on acid rain (registered in Addendum 2). This edition
gives the numbers and one important conceptual distinction.

**Scale.** Coal typically **2 % S, up to 4 %**. **4530 million tonnes of coal
produced worldwide in 1992**, generating about **90 million tonnes of S, i.e. 180
million tonnes of SO₂**. **In the UK, 85 million tonnes of coal in power stations
gives ~2.4 million tonnes of S or 4.8 million tonnes of SO₂ per year.** **Only
about 1 % of the total is recovered as H₂SO₄.**

**Wet versus dry deposition — a distinction the course does not have.** SO₂ is
oxidised by **ozone or hydrogen peroxide** to SO₃, which reacts with water or
**hydroxyl radicals** to give H₂SO₄; **ammonium sulphate also forms and is visible
as an atmospheric haze, an aerosol of fine particles**. **Wet deposition** happens
after raindrops nucleate on aerosol particles of SO₃ or (NH₄)₂SO₄ — **but SO₂
itself does not dissolve in significant amounts**. **SO₂ arrives instead by dry
deposition, absorbed directly onto solid and liquid ground surfaces.** **UK 1982
deposition: about 50 kg hectare⁻¹ year⁻¹ dry against 5 wet.** Hence the source's
own verdict: **"the name acid rain is misleading, since it refers to both wet and
dry deposition."**

**Transboundary pollution, with figures.** Tall chimney stacks **merely move the
problem to someone else**: **only 10 % of Sweden's SO₂ pollution originates in
Sweden; 80 % comes from the industrial regions of Europe and 10 % from Britain.**

**Sources.** About **60 % of atmospheric SO₂ comes from coal-fired power
stations**; the rest from oil refineries, oil-fired stations and smelters.
Abatement by `Ca(OH)₂ + SO₂ → CaSO₃ + H₂O` or `2H₂S + SO₂ → 3S + 2H₂O` over
activated alumina — **already registered from file 8; cross-reference only.**

## E. Uses of sulphur — new items only (printed 539)

Most of this box duplicates file 8 (cystine/cysteine/methionine, 90 % to H₂SO₄,
60 % of that to fertiliser, CS₂ and vulcanising). **New:**
- **Sulphur and selenium will dehydrogenate saturated hydrocarbons.**
- **Gunpowder's history:** discovered by **Roger Bacon in 1245**, the **first
  explosive able to propel a bullet or cannon ball**, first used at the **Battle
  of Crécy in 1346**, and in use for **500 years** until guncotton, nitroglycerine
  and cordite.
- *Cross-reference:* the composition is again printed with **NaNO₃ 75 %**.
  **Contradiction 16 stands** — black powder uses **potassium** nitrate, sodium
  nitrate being too hygroscopic. Two editions of one author repeating the same
  statement is **not** corroboration.

## F. Selenium and tellurium — recovery, uses and toxicology (printed 539–540)

**Where they come from.** Se and Te occur among sulphide ores and are obtained
concentrated from the **anode sludge left after the electrolytic refining of
copper** — a sludge that also holds **the platinum metals, silver and gold**. They
are also recovered from the **flue dust of roasting PbS, CuS or FeS₂**, the dust
being trapped in an **electrostatic precipitator**. **Both also occur native,
together with sulphur.**

**Selenium.** World production **1670 tonnes in 1992**. Most is used to
**decolorise glass** — while **Cd(S,Se) is used to make pink and red glass**, so
selenium both removes colour and supplies it depending on the compound.
**Xerographic photocopying:** the photoreceptor is a **thin film of Se on an
aluminium support**, sensitised electrostatically by a high voltage; an image is
focussed on it as on camera film; **areas struck by light lose their charge**;
toner sticks only to the still-charged areas, is transferred to paper and fused by
heat; the drum is then wiped, re-sensitised and reused.
**Biology and hazard:** selenium is **essential in trace amounts** and sits in
enzymes including **glutathione peroxidase, which protects cells against peroxide
attack** — **but is toxic in larger quantities.**

**Tellurium.** World production **152 tonnes in 1992**, mostly for **steel and
non-ferrous alloys, for example to harden lead**.

**Shared hazard.** **Both Se and Te compounds are absorbed by the body and
excreted as foul-smelling organic derivatives in the breath and sweat.**

## G. Polonium — an entirely new section (printed 540)

**Discovery.** Found by **Marie Curie**, by processing very large amounts of
**thorium and uranium minerals** and separating the decay products, the separation
being followed **by measuring radioactivity**. **Named after her home country,
Poland.** She shared the **1903 Nobel Prize for Physics with Becquerel and Pierre
Curie**, and won a **second Nobel Prize, for Chemistry, in 1911, for the discovery
of polonium and radium.**

**The decay chain, as printed:**
`²¹⁰₈₂Pb —β, t½ 22.3 y→ ²¹⁰₈₃Bi —β, t½ 5.0 d→ ²¹⁰₈₄Po —α, t½ 138.4 d→ ²⁰⁶₈₂Pb`

**Modern production.** **Made artificially in gram quantities from bismuth by
neutron irradiation in a nuclear reactor**, and **the metal is extracted by
sublimation**:
`²⁰⁹₈₃Bi + ¹n → ²¹⁰₈₃Bi → ²¹⁰₈₄Po + ₋₁e`

**Why polonium chemistry is barely known — the reason is chemical, not
practical.** All isotopes are highly radioactive; the most stable, **²¹⁰Po, is an
intense α emitter with a half-life of 138 days**, and **the α emission decomposes
water**, which wrecks any attempt to study polonium compounds in aqueous solution.
**That is why the chemistry of polonium is not well known** — a satisfying answer
to a question students ask and textbooks usually dodge.

*Note:* the half-life of ²¹⁰Po is given as **138.4 days** in the decay chain and
**138 days** in the prose on the same page — a rounding, not a conflict.
...
**Oxides and oxysalts:** NaClO₃ (as an oxygen source), TiCl₄ and **TiO₂**,
oxirane (ethylene oxide), CaSO₃, FeSO₄, Al₂(SO₄)₃, (NH₄)₂SO₄ (as atmospheric
aerosol), SO₃ (as aerosol nucleus).
**Sulphide minerals newly named:** **MoS₂ molybdenite**, **FeS₂ marcasite** (as
distinct from pyrites), **(Fe,Ni)₉S₈ pentlandite**, **Cu₂S chalcocite**,
**CuFeS₂ chalcopyrite**, **Cu₅FeS₄ bornite**, **Ag₂S argentite**, **ZnS
sphalerite** and **ZnS wurtzite** as a polymorph pair, **HgS cinnabar**, NiS.
**Selenium and tellurium:** **Cd(S,Se)** the glass colourant, Se metal film,
**glutathione peroxidase** (named as a selenoenzyme).
**Polonium and its chain:** **²¹⁰Pb**, **²¹⁰Bi**, **²¹⁰Po**, **²⁰⁶Pb**, **²⁰⁹Bi**.
**Expanded, existing IDs kept:** FeAsS, As₂S₃ orpiment, As₄S₄ realgar, Sb₂S₃
stibnite, Bi₂S₃ bismuthinite, PbS, CuS, FeS₂ pyrites — all first registered in
Addendum 7; only the mineral-table source page is added.

## J. Physical, numerical and observation register — additions

O₂ bond energy **493 kJ mol⁻¹** · world O₂ production **~100 Mt/yr**, 60–80 % to
steel · Bessemer charge **6 t** against BOP **100 t** · world S production **57 Mt
(1992)** with the six-route share table · Canadian natural gas **up to 20 % H₂S** ·
one Frasch borehole ≈ **half an acre** · Polish CaSO₄ route **~20 000 t/yr** at
**1200 °C** · coal **2–4 % S**; **4530 Mt** coal in 1992 → **180 Mt SO₂**; UK **85
Mt** coal → **4.8 Mt SO₂**; **~1 %** recovered · UK 1982 deposition **50 dry / 5
wet kg ha⁻¹ yr⁻¹** · Sweden's SO₂ **10 % home / 80 % continental Europe / 10 %
Britain** · **60 %** of atmospheric SO₂ from coal-fired power stations · Se
production **1670 t (1992)** · Te production **152 t (1992)** · ²¹⁰Po half-life
**138 d** (138.4 d in the chain), ²¹⁰Pb **22.3 y**, ²¹⁰Bi **5.0 d**.
**Colour and observation:** pyrites called **fool's gold**; bornite the **peacock
mineral**; **Cd(S,Se) gives pink and red glass** while Se **decolorises** it;
Se/Te compounds cause **foul-smelling breath and sweat**; H₂S **objectionable
smell**, SO₂ **acrid and corrosive**; (NH₄)₂SO₄ visible as **atmospheric haze**.

## K. Uses and hazards register — additions

**O₂** — steelmaking (basic oxygen process), oxy-acetylene welding and metal
cutting, surgical anaesthesia, TiO₂, HNO₃, oxirane, rocket oxidant, aircraft
emergency supply from NaClO₃. **S** — dehydrogenating saturated hydrocarbons;
gunpowder with its 1245/1346 history. **Se** — glass decolouriser, Cd(S,Se) glass
colourant, xerographic photoreceptor; essential trace element in glutathione
peroxidase; **toxic in quantity**. **Te** — steel and non-ferrous alloys, hardening
lead. **Se and Te together** — absorbed by the body, excreted as foul-smelling
organics. **Po** — **all isotopes highly radioactive; ²¹⁰Po an intense α emitter
whose radiation decomposes water.** **SO₂** — acid rain, damage to trees, plants,
fish and buildings, respiratory illness in humans and animals.

## L. Visual register — additions V107–V111

| ID | Required visual kind | Subject |
|---|---|---|
| V107 | **Process flow** | Liquid-air separation: the column with N₂, O₂, Ar, Ne, Kr, Xe coming off in boiling-point order, and argon flagged as the impurity that survives in both the N₂ and O₂ streams |
| V108 | **Process flow — original schematic, not the book's apparatus** | Frasch process drawn as three concentric annuli in cross-section: superheated steam down the outer, compressed air down the inner, molten sulphur up the middle, with the half-acre reach noted |
| V109 | **Process flow** | Sulphur recovery from sour gas: the one-third-burned split, `2H₂S + 3O₂` and `SO₂ + 2H₂S`, converging on elemental S |
| V110 | **Comparison graphic** | The six sulphur routes as a share chart, with the point that the smelter route dominates by mass yet delivers SO₂ rather than S |
| V111 | **Process flow + oxidation-state ladder** | Se/Te recovery from copper anode sludge and smelter flue dust, showing the accompanying Pt metals, Ag and Au |

## M. JEE trap register — items 198–208

198. **KClO₃/MnO₂ oxygen is not pure** — it carries traces of Cl₂ or ClO₂.
199. **Argon is the impurity that survives in commercial oxygen too**, not just in
     nitrogen; its boiling point lies between the two.
200. **Oxygen replaced air in steelmaking partly to avoid nitride formation**, not
     only for speed.
201. **Only Pt, Au, W and the noble gases resist dioxygen.**
202. **Most sulphur now comes from natural gas and petroleum (48 %), not from the
     Frasch process (19 %).**
203. **The Frasch process uses three concentric pipes** — superheated steam
     outside, compressed air inside, molten sulphur up the middle. Reversing steam
     and air is the standard error.
204. **Native sulphur deposits are of bacterial origin**, formed by anaerobes
     metabolising CaSO₄.
205. **FeS₂ is two minerals (pyrites and marcasite) and ZnS is two (zinc blende
     and wurtzite).** Same formula, different mineral.
206. **SO₂ reaches the ground mainly by dry deposition, not in rain** — 50 units
     dry against 5 wet in the UK in 1982. "Acid rain" is a misnomer.
207. **Selenium both decolorises glass and, as Cd(S,Se), colours it pink and red.**
208. **Polonium's aqueous chemistry is unknown because its own α radiation
     decomposes water** — not because it is scarce.

## N. Contradictions — no new items

Every equation on these six pages balances as printed. The only issue is the
recurrence of **gunpowder as NaNO₃**, which is **contradiction 16, already
registered**; its reappearance in a second edition by the same author is recorded
as **repetition, not confirmation**. **Items 25–56 preserved unchanged.**

## O. `[UNCLEAR]` register — no new items; none resolved

Nothing on this range bears on the three outstanding items (two on PDF 108, one on
PDF 145). Count remains **3**. **None guessed.**

## P. Verification status

Read from 165 dpi renders of the accessible J.D. Lee 5th-edition scan. This range
