...
export default function DBlockPart01() {
  return (
    <AppShell
      ...
      chapterSlug="d-block"
      description="A rigorous foundation for deciding what belongs to the d-block, what qualifies as a transition element, and how near-degenerate ns and (n−1)d orbitals generate the configurations used throughout the chapter."
      free={false}
