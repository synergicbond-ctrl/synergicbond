...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  // ── Testimonials ──
  "testi.eyebrow": { english: "Verified Outcomes", hindi: "सत्यापित परिणाम", hinglish: "Verified Outcomes", spanish: "Resultados Verificados", arabic: "نتائج مثبتة", french: "Résultats Vérifiés", german: "Geprüfte Ergebnisse" },
  "testi.title": { english: "Student Success Stories", hindi: "विद्यार्थी सफलता की कहानियाँ", hinglish: "Student Success Stories", spanish: "Historias de Éxito Estudiantil", arabic: "قصص نجاح الطلاب", french: "Histoires de Succès Étudiant", german: "Erfolgsgeschichten von Schülern" },
  ...
  // ── About / Mission ──
  "about.eyebrow": { english: "Why Synergic Bond", hindi: "सिनेर्जिक बॉन्ड क्यों", hinglish: "Why Synergic Bond", spanish: "Por qué Synergic Bond", arabic: "لماذا Synergic Bond", french: "Pourquoi Synergic Bond", german: "Warum Synergic Bond" },
  ...
  "about.stat1": { english: "Verified PYQs", hindi: "सत्यापित प्रश्न", hinglish: "Verified PYQs", spanish: "PYQs Verificados", arabic: "أسئلة سابقة مثبتة", french: "PYQs Vérifiés", german: "Geprüfte PYQs" },
  "about.stat2": { english: "AI Tutor Support", hindi: "AI ट्यूटर सहायता", hinglish: "AI Tutor Support", spanish: "Soporte IA 24/7", arabic: "دعم مدرس AI", french: "Tuteur IA 24/7", german: "KI-Tutor Support" },
  "about.stat3": { english: "Chemistry Focus", hindi: "केवल रसायन विज्ञान", hinglish: "Chemistry Focus", spanish: "Enfoque en Química", arabic: "تركيز كيميائي", french: "Focus Chimie", german: "Chemie-Fokus" },
  "about.pillar1body": { english: "Engineered to decode the highest-tier conceptual patterns of JEE Advanced, NEET, and International Olympiads through algorithmic problem breakdown.", hindi: "JEE Advanced, NEET और इंटरनेशनल ओलंपियाड के सबसे कठिन पैटर्न को समझने के लिए एल्गोरिद्मिक प्रॉब्लम ब्रेकडाउन के साथ बनाया गया।", hinglish: "JEE Advanced, NEET aur International Olympiads ke highest-tier patterns decode karne ke liye algorithmic problem breakdown ke saath banaya.", spanish: "Diseñado para descifrar los patrones conceptuales de más alto nivel de JEE Advanced, NEET y olimpiadas internacionales mediante análisis algorítmico.", arabic: "مصمَّم لفك أصعب الأنماط المفاهيمية لـ JEE Advanced وNEET والأولمبياد الدولي من خلال التحليل الخوارزمي.", french: "Conçu pour décoder les schémas conceptuels les plus exigeants de JEE Advanced, NEET et des olympiades internationales grâce à l'analyse algorithmique.", german: "Entwickelt, um die anspruchsvollsten konzeptionellen Muster von JEE Advanced, NEET und internationalen Olympiaden durch algorithmische Analyse zu entschlüsseln." },
  ...
  "about.pillar3body": { english: "Fine-tuned core chemistry data trained to assist students 24/7 with zero placeholders — verified chemistry explanations powered by AI speed.", hindi: "बारीकी से तैयार कोर केमिस्ट्री डेटा जो विद्यार्थियों की 24/7 मदद करता है — बिना किसी प्लेसहोल्डर के, सत्यापित केमिस्ट्री व्याख्याएं, AI की रफ़्तार के साथ।", hinglish: "Fine-tuned core chemistry data jo students ki 24/7 help karta hai — zero placeholders, verified chemistry explanations, AI speed ke saath.", spanish: "Datos químicos esenciales afinados para ayudar a los estudiantes 24/7 sin rellenos — explicaciones verificadas de química con la velocidad de la IA.", arabic: "بيانات كيمياء أساسية مُحسّنة لمساعدة الطلاب 24/7 دون حشو — تفسيرات كيمياء مثبتة بسرعة الذكاء الاصطناعي.", french: "Des données de chimie affinées pour aider les élèves 24/7 sans remplissage — des explications de chimie vérifiées à la vitesse de l'IA.", german: "Fein abgestimmte Chemie-Kerndaten, die Schüler rund um die Uhr unterstützen — ohne Platzhalter, geprüfte Chemie-Erklärungen mit KI-Tempo." },
};
