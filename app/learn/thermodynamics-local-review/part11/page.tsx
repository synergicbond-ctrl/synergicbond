...
import ThermodynamicsPart11LocalhostReview from "../_components/ThermodynamicsPart11LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 11 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 11.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart11LocalhostReview />
