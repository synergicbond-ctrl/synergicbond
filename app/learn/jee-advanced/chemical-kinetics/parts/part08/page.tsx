...
import { PartShell, ChapterSection, ConceptCard, ExamTrap, FigureFrame, FormulaCard, K, KB, ReversibleFigure, WorkedExample } from "../../chemical-kinetics-shared";
...
export default function ChemicalKineticsPart08() {
  return (
    <PartShell
      ...
      description={"Approach to equilibrium, relaxation, opposing first-order reactions and equilibrium-linked kinetics."}
    >
<ChapterSection
            id="reversible"
            index="09"
