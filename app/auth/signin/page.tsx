    ...
    <main className="flex min-h-screen items-center justify-center bg-black text-white">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/[0.03] p-8">
        ...
        <div className="mt-8 space-y-4">
          ...
          <button
            disabled
            className="w-full rounded-xl border border-white/10 bg-white/5 py-3 font-semibold text-white/30 flex items-center justify-center gap-3 cursor-not-allowed"
          >
