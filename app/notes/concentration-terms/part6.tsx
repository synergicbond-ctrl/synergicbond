      ...
      <article className="mx-auto max-w-5xl space-y-10">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2 text-xs font-mono">
              ...
              <div className="pt-2 text-rose-300 border-t border-[var(--border)] space-y-1">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-3">
              <span className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)]">Stoichiometric Derivation</span>
              <div className="overflow-x-auto py-2">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-3">
              <span className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)]">Physical Meaning of Labeling</span>
              <p className="text-xs text-[var(--text-body)]">
              ...
              <div className="overflow-x-auto py-2 border-t border-[var(--border)]">
