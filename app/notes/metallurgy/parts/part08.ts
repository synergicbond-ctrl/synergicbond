...
### Purification sequence represented in - remove Zn with acid,
...
![Cyanide process for silver and gold](/notes/metallurgy/reference/cyanide-process-dark-v4-r20260726-cachefix.webp)

![Parkes desilverisation](/notes/metallurgy/reference/parkes-process-dark-v4-r20260726-cachefix.webp)
...
asks whether Cu could be used: thermodynamically displacement is possible in some systems, but Zn is cheaper/more active and is the classical choice.
...
introduces a **partition/distribution coefficient** idea to express preferential solubility.
...
### Gold — cyanide route
uses auriferous quartz rock, dilute NaCN (~0.5% in the handwritten classroom scheme) and air/O$_2$.
$$4Au+8CN^-+O_2+2H_2O\rightarrow4[Au(CN)_2]^-+4OH^-$$
Zn precipitates crude Au:
$$2[Au(CN)_2]^-+Zn\rightarrow2Au+[Zn(CN)_4]^{2-}$$

### Purification sequence represented in 1. Acid treatment removes Zn and some base metals.
