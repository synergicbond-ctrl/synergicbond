...
export default function JeeSection() {
  return (
    <section className="relative mx-auto mt-36 max-w-7xl px-6 py-12 overflow-hidden rounded-[40px] border border-[var(--border-strong)] bg-[var(--surface)]">
      ...
      <div className="grid items-center gap-16 lg:grid-cols-2 relative z-10">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-[var(--border-strong)] bg-[var(--surface-2)] px-4 py-1.5 text-xs font-bold uppercase tracking-[0.4em] text-[var(--text-muted)] shadow-sm mb-6">
          ...
          <Link
            href="/dashboard"
            className="group mt-10 inline-flex items-center gap-2.5 rounded-[var(--radius)] bg-[var(--surface)] -500 px-8 py-4 font-extrabold text-white shadow-[0_10px_30px_rgba(59,130,246,0.4)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(59,130,246,0.6)] hover:brightness-110"
          >
