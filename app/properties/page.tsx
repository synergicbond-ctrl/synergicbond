  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-white">
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="overflow-x-auto rounded-lg border border-white/[0.06] mb-8">
          <table className="w-full text-sm min-w-[640px]">
            ...
            <tbody>
              {filtered.map((m, i) => (
                <tr key={m.f} className={i % 2 ? "bg-[var(--surface)]" : "bg-[#0e1421]"}>
        ...
        <div className="overflow-x-auto rounded-lg border border-white/[0.06]">
          <table className="w-full text-sm min-w-[640px]">
            ...
            <tbody>
              {bpmp.map((b, i) => (
                <tr key={b.c} className={i % 2 ? "bg-[var(--surface)]" : "bg-[#0e1421]"}>
        ...
        <div className="overflow-x-auto rounded-lg border border-white/[0.06]">
          <table className="w-full text-sm min-w-[560px]">
            ...
            <tbody>
              {elements.map((e, i) => (
                <tr key={e.el} className={i % 2 ? "bg-[var(--surface)]" : "bg-[#0e1421]"}>
