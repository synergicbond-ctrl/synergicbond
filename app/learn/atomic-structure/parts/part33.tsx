  ...
  return (
    <AtomicPartShell part={33} title="Magnetic Moment Calculations" pages="103-105">
      <SourcePage page={103}>
        ...
        <NoteBlock title="Question — magnetic moment of Cr⁺ˣ">
          <p>
        ...
        <NoteBlock title="Ratio of magnetic moments of Co²⁺ and Ni²⁺">
      ...
      <SourcePage page={104}>
        ...
        <NoteBlock title="Magnetic moment of Gd³⁺ (lanthanide treatment)">
