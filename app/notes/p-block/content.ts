...
**Reactions:** combustion is spontaneous and strongly exothermic — B₂H₆ + 3O₂ → B₂O₃ + 3H₂O, ΔH = −1976 kJ/mol (studied as a rocket fuel, Part 14); hydrolysis B₂H₆ + 6H₂O → 2H₃BO₃ + 6H₂; with alkali B₂H₆ + 6NaOH → 2Na₃BO₃ + 6H₂; with Cl₂ (vigorous) B₂H₆ + 6Cl₂ → 2BCl₃ + 6HCl; with LiH → LiBH₄ (stability order LiBH₄ < NaBH₄ < KBH₄, since the large BH₄⁻ anion is better stabilised by a larger cation, developed further in Part 11); with CO (470 K, 20 bar) → 2H₃B·CO; with alcohols → 2B(OR)₃ + 6H₂.
...
- **Bulletproof armour** — boron carbide, B₄C ("norbide"), from 4B + C →(electric furnace) B₄C (Part 5), is used in lightweight ceramic armour.
...
- **Glass, ceramics and adsorbents** — borax's glassy melt is used in the bead test (Part 8) and in borosilicate glass/enamel manufacture; γ-Al₂O₃'s high surface area makes it a dehydrating agent, catalyst support and chromatography adsorbent (Part 7).
...
33. Write balanced equations for BOTH the acid role and base role of B2O3, and state which partner triggers each role. *(Base role, with a stronger acidic oxide: B2O3 + 3SO3 -> B2(SO4)3. Acid role, with a basic oxide: B2O3 + 3CaO -> Ca3(BO3)2 -- see Part 7.)*
