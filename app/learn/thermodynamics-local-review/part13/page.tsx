...
import ThermodynamicsPart13LocalhostReview from "../_components/ThermodynamicsPart13LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 13 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 13.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart13LocalhostReview />

      <nav className="border-t border-white/10 bg-[#020617] px-5 py-10 text-slate-100">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          <Link
            href="/learn/thermodynamics-local-review/part12"
          ...
          <Link
            href="/learn/thermodynamics-local-review/part14"
