...
export default function HeroBlueprint({
  ...
  return (
    <div
      className={`${heightClass} rounded-lg overflow-hidden relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-slate-700 shadow-lg`}
      style={{
