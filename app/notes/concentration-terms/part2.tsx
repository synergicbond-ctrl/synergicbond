        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="grid gap-6 md:grid-cols-2 pt-2">
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2 font-mono text-xs">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="grid gap-6 md:grid-cols-2 pt-2">
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2 text-xs font-mono">
                ...
                <div className="pt-2 text-cyan-300 border-t border-[var(--border)]">
              ...
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2 text-xs font-mono">
                ...
                <div className="pt-2 text-emerald-300 border-t border-[var(--border)]">
            ...
            <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-3">
              ...
              <div className="space-y-2 text-xs font-mono text-[var(--text-body)] border-t border-[var(--border)] pt-2">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="grid gap-6 md:grid-cols-2 pt-2">
              ...
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2 font-mono text-xs">
                ...
                <div className="pt-2 text-emerald-300 border-t border-[var(--border)] space-y-1">
