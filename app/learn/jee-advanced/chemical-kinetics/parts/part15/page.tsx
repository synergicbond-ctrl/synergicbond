...
import { PartShell, ChapterSection, ConceptCard, ExamTrap, FigureFrame, K, KB, SaltEffectFigure, WorkedExample } from "../../chemical-kinetics-shared";

export default function ChemicalKineticsPart15() {
  return (
    <PartShell
      part={15}
      title={"Advanced Kinetic Extensions"}
      description={"Salt effects, isotope effects, photochemistry, chain processes, Lindemann kinetics and polymerisation."}
    >
<ChapterSection
            id="advanced"
            index="16"
