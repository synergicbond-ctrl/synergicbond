...
export default function FullSyllabusDashboard({
  ...
  const accentClass = programType === "olympiad"
    ? "from-amber-950/50 via-[#0b0f10]/90 to-[#0b0f10] border-amber-500/30"
    : programType === "entrance" && programKey === "jee-advanced"
    ? "from-violet-950/50 via-[#0b0f10]/90 to-[#0b0f10] border-violet-500/30"
    : programType === "entrance" && programKey === "neet"
    ? "from-emerald-950/50 via-[#0b0f10]/90 to-[#0b0f10] border-emerald-500/30"
    : "from-cyan-950/50 via-[#0b0f10]/90 to-[#0b0f10] border-cyan-500/30";
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-white selection:bg-cyan-500/30">
      ...
      <div className="sticky top-0 z-30 border-b border-white/[0.08] bg-[var(--background)]/97 backdrop-blur-lg shadow-[0_4px_24px_-8px_rgba(0,0,0,0.5)]">
...
function ShortNotesTab({ programName, chapters }: { programName: string; chapters: SyllabusChapterItem[] }) {
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[var(--surface)] border border-white/[0.08] p-5 rounded-2xl shadow-sm">
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Link href="/vault/formulas" className="group p-5 bg-[var(--surface)] border border-white/[0.08] hover:border-emerald-400/40 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 rounded-2xl transition-all duration-200 space-y-3">
          <div className="flex items-center justify-between">
        ...
        <Link href="/vault/exceptions" className="group p-5 bg-[var(--surface)] border border-white/[0.08] hover:border-violet-400/40 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 rounded-2xl transition-all duration-200 space-y-3">
          <div className="flex items-center justify-between">
      ...
      <div className="py-10 px-6 rounded-2xl border border-white/[0.08] bg-[var(--surface)]/70 text-center space-y-3">
...
function MockTestsTab({ 
  ...
  return (
    <div className="space-y-5">
      <div className="bg-[var(--surface)] border border-white/[0.08] p-5 rounded-2xl shadow-sm">
        <h2 className="text-xl font-black text-white flex items-center gap-2">
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {pillars.map((p, idx) => (
          <div key={idx} className="p-5 rounded-2xl bg-[var(--surface)] border border-white/[0.08] hover:border-violet-400/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 flex flex-col justify-between space-y-4 transition-all duration-200">
            <div>
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {practicals.map((pr, idx) => (
          <div key={idx} className="p-5 rounded-2xl bg-[var(--surface)] border border-white/[0.08] hover:border-cyan-400/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 flex flex-col justify-between space-y-4 transition-all duration-200">
            <div>
              <div className="flex items-center justify-between gap-2">
