      ...
      <article className="mx-auto max-w-5xl space-y-10">
        <header className="rounded-3xl border border-emerald-400/30 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 p-6 shadow-2xl md:p-8">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-bold text-[var(--text-muted)]">Quantitative Solution Chemistry</span>
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2 text-xs font-mono flex flex-col justify-between">
                <div>
                  <span className="font-bold text-white">Illustration 1: Target Molarity Volume Ratio</span>
                  <p className="text-[var(--text-body)] font-sans mt-1">
                  ...
                  <div className="mt-3 text-cyan-300 space-y-1 border-t border-[var(--border)] pt-2">
              ...
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2 text-xs font-mono flex flex-col justify-between">
                <div>
                  ...
                  <div className="mt-3 text-amber-300 space-y-1 border-t border-[var(--border)] pt-2">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="overflow-x-auto py-3 bg-[var(--background)] rounded-2xl border border-[var(--border)] px-4">
            ...
            <div className="grid gap-6 md:grid-cols-2 pt-2 text-xs font-mono">
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2">
                ...
                <div className="mt-2 text-cyan-300 border-t border-[var(--border)] pt-2">
              ...
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2">
                ...
                <div className="mt-2 text-emerald-300 border-t border-[var(--border)] pt-2">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 text-center flex flex-col justify-center">
                ...
                <p className="text-xs text-[var(--text-muted)] mt-1">For any binary solution: <InlineMath math="\chi_A + \chi_B = 1" />.</p>
              </div>
            </div>

            <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-2 text-xs font-mono">
              ...
              <div className="pt-2 text-amber-300 border-t border-[var(--border)] space-y-1">
