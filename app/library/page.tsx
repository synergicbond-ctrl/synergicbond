...
const domains: Domain[] = [
  {
    ...
    books: [
      ...
      { title: "The Nature of the Chemical Bond", author: "Linus Pauling", level: "Research (classic)", country: "USA", flag: "🇺🇸" },
      { title: "Theoretical Inorganic Chemistry", author: "Day & Selbin", level: "Advanced", country: "USA", flag: "🇺🇸" },
      { title: "Inorganic Chemistry", author: "Purcell & Kotz", level: "Advanced / Research", country: "USA", flag: "🇺🇸" },
      { title: "Introduction to Ligand Fields", author: "B.N. Figgis", level: "Research", country: "UK", flag: "🇬🇧" },
      { title: "Inorganic Chemistry", author: "Heslop & Jones", level: "Advanced", country: "UK", flag: "🇬🇧" },
      { title: "Treatise on Inorganic Chemistry", author: "Heinrich Remy", level: "Research", country: "Germany", flag: "🇩🇪" },
  ...
  },
  {
    ...
    books: [
      ...
      { title: "Basic Principles of Organic Chemistry", author: "Roberts & Caserio", level: "Foundation → Advanced", country: "USA", flag: "🇺🇸" },
      { title: "Introduction to Organic Chemistry", author: "Streitwieser & Heathcock", level: "Advanced", country: "USA", flag: "🇺🇸" },
      { title: "Advanced Organic Chemistry / Reagents", author: "Fieser & Fieser", level: "Research", country: "USA", flag: "🇺🇸" },
      { title: "Mechanism & Structure in Organic Chemistry", author: "E.S. Gould", level: "Research", country: "USA", flag: "🇺🇸" },
      { title: "Mechanism & Theory in Organic Chemistry", author: "Lowry & Richardson", level: "Research", country: "USA", flag: "🇺🇸" },
      { title: "Modern Synthetic Reactions", author: "Herbert O. House", level: "Research", country: "USA", flag: "🇺🇸" },
      { title: "Organic Synthesis: The Disconnection Approach", author: "Stuart Warren", level: "Advanced / Research", country: "UK", flag: "🇬🇧" },
      { title: "Organic Chemistry", author: "Marc Loudon", level: "Advanced", country: "USA", flag: "🇺🇸" },
      { title: "Organic Chemistry (MIR)", author: "Petrov, Balyan & Troshchenko", level: "Advanced", country: "Russia", flag: "🇷🇺" },
      { title: "Advanced Organic Chemistry", author: "Bahl & Bahl", level: "Foundation → Advanced", country: "India", flag: "🇮🇳" },
    ],
  },
  {
    ...
    books: [
      ...
      { title: "Physical Chemistry (MIR)", author: "Ya. Gerasimov et al.", level: "Advanced", country: "Russia", flag: "🇷🇺" },
      { title: "Physical Chemistry", author: "Daniels & Alberty", level: "Advanced", country: "USA", flag: "🇺🇸" },
      { title: "Physical Chemistry", author: "Silbey, Alberty & Bawendi", level: "Advanced", country: "USA", flag: "🇺🇸" },
      { title: "Physical Chemistry", author: "Gordon M. Barrow", level: "Advanced", country: "USA", flag: "🇺🇸" },
      { title: "Chemical Kinetics", author: "Keith J. Laidler", level: "Advanced / Research", country: "Canada", flag: "🇨🇦" },
      { title: "Introduction to Quantum Mechanics", author: "Pauling & Wilson", level: "Research (classic)", country: "USA", flag: "🇺🇸" },
      { title: "Elementary Quantum Chemistry", author: "Frank L. Pilar", level: "Research", country: "USA", flag: "🇺🇸" },
    ],
  },
  {
    ...
    books: [
      ...
      { title: "Organic Structures from Spectra", author: "Field, Sternhell & Kalman", level: "Advanced", country: "Australia", flag: "🇦🇺" },
      { title: "Applications of Absorption Spectroscopy of Organic Compounds", author: "John R. Dyer", level: "Advanced", country: "USA", flag: "🇺🇸" },
      { title: "Application of UV, IR, NMR & Mass Spectroscopy (MIR)", author: "Kazitsyna & Kupletskaya", level: "Advanced", country: "Russia", flag: "🇷🇺" },
      { title: "Stereochemistry of Organic Compounds", author: "D. Nasipuri", level: "Advanced / Olympiad", country: "India", flag: "🇮🇳" },
      { title: "Introduction to Stereochemistry", author: "Kurt Mislow", level: "Research", country: "USA", flag: "🇺🇸" },
    ],
  },
  {
    ...
    books: [
      ...
      { title: "Principles of Instrumental Analysis", author: "Skoog, Holler & Crouch", level: "Advanced / Research", country: "USA", flag: "🇺🇸" },
    ],
  },
  {
    ...
    books: [
      ...
      { title: "Chemistry: The Central Science", author: "Brown, LeMay & Bursten", level: "Foundation → Advanced", country: "USA", flag: "🇺🇸", rank: 3 },
      { title: "General Chemistry (MIR)", author: "B.V. Nekrasov", level: "Foundation / Advanced", country: "Russia", flag: "🇷🇺" },
      { title: "Principles of Modern Chemistry", author: "Oxtoby, Gillis & Butler", level: "Advanced", country: "USA", flag: "🇺🇸" },
      { title: "Chemistry", author: "Steven S. Zumdahl", level: "Foundation → Advanced", country: "USA", flag: "🇺🇸" },
      { title: "General Chemistry", author: "Ralph H. Petrucci", level: "Foundation → Advanced", country: "USA", flag: "🇺🇸" },
    ],
  },
];
