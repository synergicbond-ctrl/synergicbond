...
export default function IsomerismPart30() {
  return <main className="min-h-screen bg-[#08111f] px-4 py-8 text-white sm:px-6 sm:py-12"><article className="mx-auto max-w-7xl">
    ...
    <header className="mt-6 rounded-3xl border border-cyan-300/15 bg-[radial-gradient(circle_at_top_right,_rgba(34,211,238,.18),_transparent_35%),linear-gradient(135deg,rgba(34,211,238,.08),rgba(2,6,23,.7),rgba(139,92,246,.1))] p-6 sm:p-9"><p className="text-xs font-black uppercase tracking-[.24em] text-cyan-200">Optical Isomerism source · page 105 · Part 30</p><h1 className="mt-3 text-3xl font-black sm:text-5xl">Identify optically active compounds</h1><p className="mt-3 max-w-4xl text-sm leading-7 text-[var(--text-body)]">The source worksheet tests axial chirality, symmetry and conformational stability. Each numbered source structure below is independently retained; a check means active and a cross means inactive.</p></header>
