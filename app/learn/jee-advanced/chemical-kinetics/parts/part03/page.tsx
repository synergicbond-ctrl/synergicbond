...
import { ChapterSection, ConceptCard, FigureFrame, FormulaCard, IntegratedPlotsFigure, IntegratedSourcePages, K, KB, KeyIdea, PartShell, ReferenceExpansion, WorkedExample } from "../../chemical-kinetics-shared";

export default function ChemicalKineticsPart03() {
  return (
    <PartShell part={3} title={"First-, Second- and Higher-Order Kinetics"} description={"Complete integrated equations, half-life relations, pseudo-order conditions and unequal-concentration second-order cases."}>
      <ChapterSection
            id="integrated"
            index="06"
      ...
      <ReferenceExpansion sheets={[7, 8, 9, 11, 12, 13, 14, 15]} />
      <IntegratedSourcePages start={31} end={46} />
    </PartShell>
  );
}
