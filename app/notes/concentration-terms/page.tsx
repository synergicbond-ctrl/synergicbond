...
export const metadata = {
  title: "Concentration Terms — SYNERGIC BOND",
  description: "Comprehensive notes for Concentration Terms.",
};

export default function ConcentrationTermsHubPage() {
  const course = sbcCourse("concentration-terms");
  ...
  return (
    <AppShell
      ...
      chapterSlug="concentration-terms"
