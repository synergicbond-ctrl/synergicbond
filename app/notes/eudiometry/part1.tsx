...
const ConceptCard = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="my-6 rounded-lg border border-cyan-400/30 bg-slate-900/90 p-6 shadow-xl">
...
const FormulaBox = ({ title, formula, description }: { title: string; formula: string; description?: string }) => (
  <div className="my-6 rounded-lg border border-amber-400/30 bg-slate-950 p-6 shadow-lg text-center space-y-3">
