    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      {cards.map((card) => (
        <article key={card.title} className={`rounded-lg border p-5 ${toneMap[card.tone]}`}>
          ...
          <p className="mt-3 text-xs leading-5 text-[var(--text-muted)]">{card.reverse}</p>
        </article>
      ))}
    </div>
  );
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      {steps.map((step) => (
        <article key={step.title} className={`rounded-lg border p-5 ${toneMap[step.tone]}`}>
          ...
          <div className="mt-3 rounded-xl bg-[var(--surface-2)] p-3 text-center font-mono text-xs font-semibold text-[var(--foreground)]">
            {step.equation}
          </div>
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      <article className="rounded-lg border border-cyan-300/20 bg-cyan-300/[0.05] p-5">
        <h3 className="font-display text-xl font-semibold text-[var(--foreground)]">Constant-volume heating</h3>
      ...
      <article className="rounded-lg border border-amber-300/20 bg-amber-300/[0.05] p-5">
        <h3 className="font-display text-xl font-semibold text-[var(--foreground)]">Constant-pressure heating</h3>
        <Formula label="General">
    ...
    <div className="grid gap-4 lg:grid-cols-2">
      {items.map((item) => (
        <article key={item.title} className="rounded-lg border border-[var(--border)] bg-[var(--surface)] p-5">
          ...
          <p className="mt-4 leading-7 text-[var(--text-body)]">{item.problem}</p>
