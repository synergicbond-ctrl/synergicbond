...
function TriangleStructure({ v }: { v: number }) {
  ...
  return <svg viewBox="0 0 170 140" className="h-auto w-full text-slate-100" role="img" aria-label={`source structure ${v}, individually drawn cyclopropane or cyclopropene`}><g fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
...
function SquareStructure({ v }: { v: number }) {
  ...
  return <svg viewBox="0 0 170 140" className="h-auto w-full text-slate-100" role="img" aria-label={`source structure ${v}, individually drawn cyclobutane or cyclobutene`}><g fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
...
function PentagonStructure({ v }: { v: number }) {
  ...
  return <svg viewBox="0 0 170 145" className="h-auto w-full text-slate-100" role="img" aria-label={`source structure ${v}, individually drawn cyclopentane or cyclopentene`}><g fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
