    ...
    <Shell>
      ...
      <section>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link href="/pyq" className="rounded-xl border border-[var(--accent)]/30 bg-[var(--accent)]/10 px-4 py-2 text-sm font-semibold text-[var(--accent)] transition hover:bg-[var(--accent)]/10">
