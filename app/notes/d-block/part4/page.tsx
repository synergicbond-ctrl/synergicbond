...
export default function DBlockPart04() {
  return (
    <AppShell
      ...
      chapterSlug="d-block"
      description="A systematic account of the oxidation-state skyline, the special roles of oxygen and fluorine, oxide acidity, halide stability, adjacent-state redox behaviour, disproportionation and ligand control."
      free={false}
