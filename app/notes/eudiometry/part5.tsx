          ...
          <div className="rounded-lg border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-xs font-mono">
                <thead>
                  <tr className="border-b border-[var(--border)] bg-[var(--background)] text-[var(--text-muted)]">
                ...
                <tbody className="divide-y divide-[var(--border)] text-[var(--foreground)]">
                  ...
                  <tr>
                    ...
                    <td className="p-3 font-bold text-white">Hydrogen (<InlineMath math="\text{H}_2" />)</td>
