      ...
      <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <label className="sm:hidden">
          ...
          <select
            ...
            className="w-full rounded-xl border border-cyan-400/30 bg-[var(--background)] px-4 py-2.5 text-sm font-semibold text-cyan-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300"
          >
