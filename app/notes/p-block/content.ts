// Original P-block master notes. Facts and reaction anchors are authored for
// this course; do not substitute scans or verbatim coaching/book material.
// Verification order: NCERT first, then standard inorganic references and
// independently checked JEE Advanced/Olympiad-level material.

export const P_BLOCK_MASTER_MARKDOWN = String.raw`## Source & verification protocol

**Primary factual anchor:** NCERT Chemistry (Class XI, *The p-Block Elements*; Class XII, *The p-Block Elements*, where applicable to the current syllabus). Tables, reactions, names and syllabus boundaries are checked here first.

**Secondary conceptual checks:** J. D. Lee's *Concise Inorganic Chemistry* and Greenwood & Earnshaw's *Chemistry of the Elements*. Advanced context is reconciled with Sudarshan Guha's JEE Advanced inorganic notes and the named INChO/NSEC and coaching material (Allen, Narayana, Sri Chaitanya, Physics Wallah, Nucleus, Vibrant) only when it does not conflict with NCERT or established inorganic chemistry. Coaching sheets, AITS and test papers are used to identify question patterns and exception traps — not copied as prose.

> **Exam rule:** Learn the NCERT statement first. Use an advanced explanation only to justify or extend it; never let a shortcut or a coaching mnemonic overturn the NCERT fact.
...
- For an oxoacid, count ionisable O–H hydrogens; hydrogen attached directly to the central atom is normally non-ionisable (§5).
...
With ammonia it forms an adduct that, on controlled heating, loses hydrogen to give **borazine**, B₃N₃H₆ (§11.4).
...
# 3. Group 14: carbon, silicon, catenation and the inert-pair effect
...
## 3.1 General trends and the classic tetrahalide-hydrolysis exception
...
## 3.3 Silicon chemistry: SiO₂, silicates and zeolites
...
# 4. Group 15: nitrogen, ammonia and nitrogen oxides
...
## 4.1 Dinitrogen: why it is inert yet essential
...
## 4.2 Ammonia and the Haber process
...
**Always name which reagent is in excess before writing the product** — this reagent-ratio discipline recurs throughout p-block chemistry (§3.2, §12.3).

## 4.3 Nitric acid and nitrogen oxides
...
## 4.4 Phosphorus: white vs red, and PH₃ vs NH₃
...
# 5. Group 15: phosphorus oxoacids and high-yield comparisons
...
## 5.1 Oxidation-state discipline vs structural (basicity) discipline
...
# 6. Group 16: oxygen, ozone and sulphur
...
## 6.2 Sulphur dioxide and sulphuric acid
...
# 7. Group 16: oxoacids of sulphur and redox logic
...
## 7.1 Peroxo acids: never assume every oxygen is −2
...
## 7.2 Thiosulphate: two inequivalent sulphur atoms
...
# 8. Group 17: halogens, interhalogens and oxoacids
...
## 8.1 The electron-gain-enthalpy vs electronegativity trap
...
## 8.3 Chlorine, disproportionation and bleaching powder
...
# 9. Group 18: noble gases and xenon compounds
...
## 9.1 Preparation of xenon fluorides
...
## 9.2 VSEPR precision for xenon species
...
# 10. JEE Advanced synthesis: decision trees, traps and final recall

## 10.1 Three decision trees for any p-block question
...
## 10.2 Rapid trap bank — full block
...
## 10.3 How to use these notes with practice questions
...
> **Final NCERT-first rule:** Whenever a numerical datum, a named preparation condition, or a specific reaction detail is disputed between sources, verify the current NCERT text first; use J. D. Lee, Greenwood & Earnshaw, or a trusted coaching key only as a secondary, confirmatory check — never as the deciding source over NCERT.

# 11. Group 13 deep dive: borax, boric acid, BF₃, diborane and alums

## 11.1 Borax and the borax-bead test
...
## 11.2 Orthoboric acid: the Lewis-acid mechanism in full
...
## 11.3 BF₃ and back donation, in mechanistic detail
...
## 11.4 Diborane reaction set, including borazine
...
## 11.5 Aluminium chloride and alums, in full
...
# 12. Group 14 deep dive: allotropes, carbon oxides and silicon materials

## 12.1 Carbon allotropes and structure–property links
...
## 12.2 Carbon monoxide: formation, reactivity and toxicity
...
## 12.3 Carbon dioxide: ratio-dependent reactions
...
For a **limited quantity of base relative to CO₂**, the bicarbonate ion is favoured; for **excess base**, the fully deprotonated carbonate ion is favoured. This reagent-ratio discipline — identical in spirit to the ammonia/chlorine excess rule (§4.2) — is essential across essentially every p-block acid–base and redox reaction in this syllabus.

## 12.4 Silicon tetrachloride, silica and glass
...
# 14. Group 15 deep dive: nitrogen, ammonia, nitrides and nitric acid

## 14.1 Nitrogen fixation and the different classes of nitride
...
## 14.2 Ammonia: laboratory preparation and diagnostic reactions
...
## 14.3 The Ostwald process for nitric acid
...
# 15. Nitrogen oxides, phosphorus allotropes and chlorides

## 15.1 Comparing the nitrogen oxides
...
## 15.2 Phosphorus allotropes, compared precisely
...
## 15.3 PCl₃ and PCl₅: hydrolysis and phase-dependent shape
...
# 17. Sulphur dioxide, sulphuric acid and contact-process mastery

## 17.1 SO₂ as both reducing and oxidising agent
...
## 17.2 The contact-process sequence, stage by stage
...
# 18. Group 17 deep dive: chlorine, HCl and oxyacids

## 18.1 Chlorine preparation and its temperature-dependent disproportionation
...
## 18.2 HCl behaviour and chloride identification
...
## 18.3 Oxoacid strength: same-central-atom comparisons only
...
# 19. Interhalogens: structure, hydrolysis and reactivity
...
## 20.3 Xenon oxyfluorides and oxides
...
## 20.4 Advanced edge: a safe, general hydrolysis workflow
