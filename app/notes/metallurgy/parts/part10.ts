...
organises Mg extraction in three major steps:
1. preparation of hydrated $MgCl_2\cdot6H_2O$,
2. conversion to **anhydrous $MgCl_2$** without hydrolysis,
3. fused-salt electrolysis.

![Fused magnesium chloride electrolysis](/assets/metallurgy/restored-889e823/molten-electrolysis-dark-v4.webp)
...
“65 ppm MgCl$_2$” value is not a reliable seawater composition figure; seawater contains much more dissolved Mg$^{2+}$ (order of g L$^{-1}$), so that handwritten number should not be memorised.
...
- mentions coal gas historically; modern practice uses controlled protective atmospheres.
