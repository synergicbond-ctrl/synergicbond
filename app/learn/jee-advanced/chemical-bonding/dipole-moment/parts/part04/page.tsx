  ...
  return (
    ...
    >
      ...
      >
        ...
        <FigureFrame title="CO: four competing contributions" caption="Lone pairs cancel; μh and μe both point toward O; the dative moment (2p(O) → 2p(C)) points toward C and dominates, leaving a small residual moment toward carbon.">
          <DipoleStructureFigure id="co-detailed-breakdown" />
        </FigureFrame>
