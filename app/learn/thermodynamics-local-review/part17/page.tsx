...
import ThermodynamicsPart17LocalhostReview from "../_components/ThermodynamicsPart17LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 17 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 17.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart17LocalhostReview />
