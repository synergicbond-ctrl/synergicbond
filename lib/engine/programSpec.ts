...
export const CHAPTER_PYQ_MAP: Record<string, PYQChapter[]> = {
  ...
  "f-block-elements": ["d and f Block Elements"],
  "hydrogen": ["Hydrogen"],
...
export const AUTHORED_NOTES: Record<string, string> = {
  ...
  "states-of-matter": "/learn/gaseous-state",
  "surface-chemistry": "/learn/jee-advanced/surface-chemistry",
  "chemical-kinetics": "/learn/jee-advanced/chemical-kinetics",
