...
export default function GlobalSearchPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-white p-6 md:p-12 max-w-5xl mx-auto space-y-10">
      ...
      {/* Search Input Form */}
      <form onSubmit={handleSearch} className="flex flex-col gap-3 bg-[var(--surface)] p-2 rounded-lg border border-white/[0.08] max-w-3xl mx-auto sm:flex-row focus-within:border-cyan-400/40 transition">
        <input
          type="text"
          value={query}
