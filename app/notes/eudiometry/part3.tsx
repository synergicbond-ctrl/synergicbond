...
const ConceptCard = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="my-6 rounded-lg border border-emerald-400/30 bg-[var(--surface)] p-6 shadow-xl">
    <h3 className="border-b border-[var(--border)] pb-3 text-lg font-bold text-emerald-300">{title}</h3>
...
const FormulaBox = ({ title, formula, description }: { title: string; formula: string; description?: string }) => (
  <div className="my-6 rounded-lg border border-cyan-400/30 bg-[var(--background)] p-6 shadow-lg text-center space-y-3">
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] px-4 py-8 text-[var(--foreground)] md:px-10">
      <article className="mx-auto max-w-5xl space-y-10">
        {/* Module Header */}
        <header className="rounded-lg border border-emerald-400/30 bg-[var(--surface)] p-6 shadow-2xl md:p-8">
        ...
        <section className="space-y-6">
          ...
          <ConceptCard title="Why Does Volume Contraction Occur Upon Explosion?">
            ...
            <ul className="list-disc ml-5 space-y-2 text-xs text-[var(--text-muted)] pt-1">
              <li>
