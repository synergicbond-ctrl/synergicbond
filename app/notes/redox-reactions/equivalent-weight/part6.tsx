...
<PageCard title="n-Factor of Components in Redox Reaction">
          ...
          <div className="space-y-4 rounded-lg border border-amber-500/20 bg-amber-950/20 text-amber-200 p-4">
        ...
        <PageCard title="Equivalent Volume of a Gas">
          ...
          <div className="space-y-3 rounded-lg border border-amber-500/20 bg-amber-950/20 text-amber-200 p-4">
            <WorkingLine>
