  ...
  return (
    <section className="mx-auto max-w-7xl px-6 pt-2 pb-6">
      ...
      <div className="text-center mb-6">
        <div className="inline-flex items-center gap-2 rounded-full border border-[var(--border-strong)] bg-[var(--surface)] -500/10 px-4 py-1.5 text-[var(--text-muted)] text-xs font-bold tracking-wider mb-4">
      ...
      <form onSubmit={submit} className="mx-auto max-w-3xl mb-6">
        <div className="relative group">
          <div className="absolute -inset-0.5 rounded-[var(--radius)] bg-[var(--surface)] -500 opacity-30 blur-md transition duration-300 group-hover:opacity-60 group-focus-within:opacity-80" />
          <div className="relative">
            <Search className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-[var(--text-muted)] transition-transform duration-300 group-focus-within:scale-110" />
            <input
              value={q}
              onChange={(e) => setQ(e.target.value)}
              placeholder="Ask anything — “Why is SN1 fastest for 3° carbon?”, search a reaction, formula, element…"
              className="w-full rounded-[var(--radius)] border border-white/15 bg-[var(--background)]/90 pl-14 pr-28 py-4.5 text-sm md:text-base text-white placeholder-white/40 outline-none transition-all duration-300 focus:border-[var(--border-strong)] focus:bg-[var(--surface)] focus:"
            />
            <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 rounded-xl bg-[var(--surface)] -400 px-5 py-2.5 text-sm font-extrabold text-black shadow-lg transition-all duration-200 hover:scale-105 hover:">
              Ask AI
            </button>
          </div>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr] mb-12">
        ...
        <div className="relative overflow-hidden rounded-[var(--radius)] border border-white/15 bg-[var(--surface)] p-6 md:p-7 shadow-2xl">
          <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-[var(--surface-2)] blur-3xl pointer-events-none" />
          
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2.5">
              <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[var(--surface-2)] border border-[var(--border-strong)]">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[var(--border-strong)] bg-[var(--surface-2)] px-3 py-1 text-[11px] font-bold text-[var(--text-muted)]">
              <span className="h-1.5 w-1.5 rounded-full bg-[var(--surface)] animate-pulse" />
              SYSTEM ACTIVE
            </span>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
            <div className="rounded-[var(--radius)] border border-white/10 bg-white/[0.03] p-4 transition-all duration-300 hover:border-[var(--border-strong)] hover:bg-white/[0.05]">
              <div className="flex items-center gap-2 text-xs text-white/50 mb-1">
                <Award className="h-3.5 w-3.5 text-[var(--text-muted)]" /> XP
              </div>
              <div className="text-2xl font-black text-white tracking-tight">2,450 <span className="text-xs font-bold text-[var(--text-muted)]">XP</span></div>
            </div>

            <div className="rounded-[var(--radius)] border border-white/10 bg-white/[0.03] p-4 transition-all duration-300 hover:border-[var(--border-strong)] hover:bg-white/[0.05]">
              <div className="flex items-center gap-2 text-xs text-white/50 mb-1">
                <CheckCircle2 className="h-3.5 w-3.5 text-[var(--text-muted)]" /> Questions Solved
              </div>
              <div className="text-2xl font-black text-white tracking-tight">42 <span className="text-xs font-bold text-[var(--text-muted)]">Solved</span></div>
            </div>

            <div className="col-span-2 sm:col-span-1 rounded-[var(--radius)] border border-white/10 bg-white/[0.03] p-4 transition-all duration-300 hover:border-[var(--border-strong)] hover:bg-white/[0.05]">
              <div className="flex items-center gap-2 text-xs text-white/50 mb-1">
                <Flame className="h-3.5 w-3.5 text-[var(--text-muted)]" /> Current Streak
              </div>
              <div className="text-2xl font-black text-white tracking-tight">7 <span className="text-xs font-bold text-[var(--text-muted)]">Days 🔥</span></div>
            </div>
          </div>

          <div className="rounded-[var(--radius)] border border-[var(--border-strong)] bg-[var(--surface)]/[0.04] p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-start gap-3">
              <ShieldAlert className="h-5 w-5 text-[var(--text-muted)] shrink-0 mt-0.5" />
              <div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--text-muted)]">Weakest Topic Flagged</span>
                <p className="text-sm font-bold text-white">Ionic Equilibrium (pH &amp; Buffer Systems)</p>
              </div>
            </div>
            <Link href="/quiz" className="inline-flex items-center justify-center gap-1.5 rounded-xl bg-[var(--surface-2)] border border-[var(--border-strong)] px-3.5 py-2 text-xs font-bold text-[var(--text-muted)] transition hover:bg-[var(--surface-2)] shrink-0">
        ...
        {/* Activity Feed UI */}
        <div className="relative overflow-hidden rounded-[var(--radius)] border border-white/15 bg-[var(--surface)] p-6 md:p-7 shadow-2xl flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 rounded-[var(--radius)] border border-white/[0.07] bg-white/[0.02] p-3.5 transition hover:border-white/15 hover:bg-white/[0.04]">
                <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[var(--surface-2)] text-[var(--text-muted)]">
                  <FlaskConical className="h-4 w-4" />
                </span>
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-[var(--text-muted)]">Quiz Completed</span>
              ...
              <div className="flex items-start gap-3 rounded-[var(--radius)] border border-white/[0.07] bg-white/[0.02] p-3.5 transition hover:border-white/15 hover:bg-white/[0.04]">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-[var(--text-muted)]">AI Tutor Session</span>
              ...
              <div className="flex items-start gap-3 rounded-[var(--radius)] border border-white/[0.07] bg-white/[0.02] p-3.5 transition hover:border-white/15 hover:bg-white/[0.04]">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-[var(--text-muted)]">Chapter Learned</span>
          ...
          <div className="mt-4 pt-3 border-t border-white/[0.06] text-center">
            <Link href="/vault" className="text-xs font-bold text-[var(--text-muted)] hover:text-white transition inline-flex items-center gap-1">
      ...
      {(() => {
        ...
        return (
          <div className="mb-12 rounded-[var(--radius)] p-[1.5px] bg-[var(--surface)] transition-all duration-500 hover:">
            <div className="rounded-[var(--radius)] bg-[var(--background)] p-6 md:p-8">
              <div className="flex flex-wrap items-center gap-2 mb-6">
                <Compass className="h-4.5 w-4.5 text-[var(--text-muted)]" />
                <h2 className="text-xs font-bold uppercase tracking-[0.3em] text-[var(--text-muted)]">What should I do next?</h2>
                <span className="rounded-full bg-[var(--surface-2)] px-2.5 py-0.5 text-[10px] font-bold text-[var(--text-muted)] border border-[var(--border-strong)] shadow-sm">AI&nbsp;GUIDED</span>
                {!isReal && (
                  <Link href="/login" className="ml-auto inline-flex items-center gap-1.5 rounded-full border border-[var(--border-strong)] bg-[var(--surface)]/[0.1] px-3 py-1 text-[11px] font-semibold text-[var(--text-muted)] transition hover:bg-[var(--surface-2)] hover:scale-105">
              ...
              <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
                ...
                <Link
                  href={primary.href}
                  className="group relative overflow-hidden rounded-[var(--radius)] border p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
                ...
                <div className="flex flex-col gap-3 justify-center">
                  ...
                  {rest.map((a) => {
                    ...
                    return (
                      <Link key={a.label} href={a.href} className="group flex items-center gap-3.5 rounded-[var(--radius)] border border-white/[0.08] bg-[var(--surface)]/90 px-4 py-3.5 transition-all duration-200 hover:-translate-y-0.5 hover:border-white/25 hover:bg-[#1a2332] hover:shadow-lg">
      ...
      <div className="grid gap-5 md:grid-cols-3 mb-12">
        {coreCards.map((card) => {
          ...
          return (
            <div key={card.title} className="group rounded-[var(--radius)] bg-[var(--surface)] border border-white/[0.08] p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-white/20 hover:shadow-2xl">
          ...
          return (
            <Link key={e.exam} href={e.href} className="group rounded-[var(--radius)] border p-6 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl" style={{ borderColor: `${e.c}80`, background: `linear-gradient(145deg, ${e.c}12, var(--surface) 34%)`, boxShadow: `inset 0 1px 0 ${e.c}1a` }}>
              ...
              <div className="flex flex-col gap-2">
                ...
                }) : <span className="text-xs text-[var(--text-muted)] font-medium py-1">None flagged yet 🎉</span>}
              </div>
            </Link>
          );
        })}
      ...
      <Link href="/live" className="group block rounded-[var(--radius)] p-[1.5px] mb-10 bg-[var(--surface)] -500/60 to-transparent transition-all duration-300 hover:">
        <div className="rounded-[var(--radius)] bg-[var(--background)] p-6 flex items-center gap-6 flex-wrap">
          <div className="flex items-center gap-2.5">
            <span className="relative flex h-3.5 w-3.5"><span className="absolute inline-flex h-full w-full rounded-full bg-[var(--surface)] opacity-75" /><span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-[var(--surface)]" /></span>
            <span className="text-sm font-black text-[var(--text-muted)] tracking-wider">LIVE NOW</span>
          </div>
          <div className="flex items-center gap-2 text-sm text-white/80 font-medium"><Users className="h-4 w-4 text-[var(--text-muted)]" /> <b className="text-white tabular-nums font-bold">{online.toLocaleString()}</b> online</div>
          <div className="flex items-center gap-2 text-sm text-white/80 font-medium"><Zap className="h-4 w-4 text-[var(--text-muted)]" /> 2 mocks running</div>
          <div className="flex items-center gap-2 text-sm text-white/80 font-medium"><Trophy className="h-4 w-4 text-[var(--text-muted)]" /> Rank Rush in <b className="text-white font-bold">2h 15m</b></div>
          <span className="ml-auto inline-flex items-center gap-2 text-sm font-bold text-[var(--text-muted)] transition-all duration-200 group-hover:gap-3">Enter Arena <ArrowRight className="h-4 w-4" /></span>
        </div>
      </Link>
      ...
      <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
        {features.map((f) => {
          const Icon = f.icon;
          return (
            <Link key={f.href} href={f.href} className="group relative rounded-[var(--radius)] bg-[var(--surface)]/80 border border-white/[0.08] p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-white/25 hover:shadow-xl">
              {f.soon && <span className="absolute top-4 right-4 text-[9px] font-extrabold tracking-wider text-[var(--text-muted)] bg-[var(--surface-2)] px-2 py-0.5 rounded-full border border-[var(--border-strong)]">SOON</span>}
