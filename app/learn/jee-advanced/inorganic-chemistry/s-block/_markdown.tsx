  ...
  h1: ({ children }) => {
    ...
    return (
      <section className="mt-12 first:mt-0">
        <h2 id={slugify(text)} className="scroll-mt-24 border-t border-[var(--border)] pt-10 font-display text-3xl font-black leading-tight tracking-tight text-[var(--foreground)] sm:text-4xl">
          {children}
        </h2>
      </section>
    );
