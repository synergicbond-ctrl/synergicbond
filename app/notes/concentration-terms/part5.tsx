      ...
      <article className="mx-auto max-w-5xl space-y-10">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-lg border border-slate-800 bg-slate-900 p-6 space-y-4 text-sm leading-relaxed text-slate-200">
            ...
            <div className="overflow-x-auto py-3 bg-slate-950 rounded-lg border border-slate-800 px-4 space-y-2">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-lg border border-slate-800 bg-slate-900 p-6 space-y-4 text-sm leading-relaxed text-slate-200">
            ...
            <div className="overflow-x-auto py-3 bg-slate-950 rounded-lg border border-slate-800 px-4 text-center">
