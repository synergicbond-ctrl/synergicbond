...
import ThermodynamicsPart28LocalhostReview from "../_components/ThermodynamicsPart28LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 28 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 28.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart28LocalhostReview />
      ...
      <nav className="border-t border-white/10 bg-[#020617] px-5 py-10 text-slate-100">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          ...
          <Link
            href="/learn/thermodynamics-local-review/part29"
