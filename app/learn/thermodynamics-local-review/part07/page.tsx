...
import ThermodynamicsPart07LocalhostReview from "../_components/ThermodynamicsPart07LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 07 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 07.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart07LocalhostReview />
