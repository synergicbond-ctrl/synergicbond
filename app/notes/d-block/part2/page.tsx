...
export default function DBlockPart02() {
  return (
    <AppShell
      ...
      chapterSlug="d-block"
      description="A data-led account of the modest contraction across a transition row, the powerful lanthanoid contraction between 4d and 5d elements, and the way compact atomic volumes create unusually dense metals."
      free={false}
