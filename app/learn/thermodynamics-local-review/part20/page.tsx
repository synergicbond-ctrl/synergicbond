...
import ThermodynamicsPart20LocalhostReview from "../_components/ThermodynamicsPart20LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 20 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 20.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart20LocalhostReview />
