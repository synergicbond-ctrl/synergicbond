...
export default function DBlockPart09() {
  return (
    <AppShell
      ...
      chapterSlug="d-block"
      description="A complete route from pyrolusite through green manganate to purple permanganate, followed by structure, storage, thermal decomposition, medium-controlled products, balanced oxidations and autocatalytic titration chemistry."
      free={false}
