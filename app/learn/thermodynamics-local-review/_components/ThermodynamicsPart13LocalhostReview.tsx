    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      {items.map((item) => (
        <article key={item.title} className={`rounded-3xl border p-5 ${toneMap[item.tone]}`}>
          ...
          <p className="mt-3 text-sm leading-6 text-[var(--foreground)]">{item.text}</p>
        </article>
      ))}
    </div>
  );
        ...
        <tbody className="divide-y divide-white/10 bg-[var(--background)]/70">
          {rows.map(([type, natural, reverse, drive]) => (
            <tr key={type}>
              ...
              <td className="px-4 py-3 text-[var(--text-body)]">{drive}</td>
            </tr>
          ))}
        </tbody>
      </table>
        ...
        <tbody className="divide-y divide-white/10 bg-[var(--background)]/70">
          {rows.map(([name, question, focus, output]) => (
            <tr key={name}>
              ...
              <td className="px-4 py-3 text-[var(--foreground)]">{question}</td>
              <td className="px-4 py-3 text-[var(--text-body)]">{focus}</td>
              <td className="px-4 py-3 text-[var(--text-body)]">{output}</td>
            </tr>
          ))}
        </tbody>
      </table>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.05] p-6 shadow-2xl shadow-cyan-950/25">
              ...
              <div className="mt-4 space-y-3">
                <div className="rounded-xl bg-cyan-400/10 p-4">
                  ...
                  <p className="mt-1 text-sm text-[var(--text-body)]">Does the energy balance close?</p>
                </div>
                <div className="rounded-xl bg-violet-400/10 p-4">
                  <p className="font-black text-violet-200">Second Law</p>
                  <p className="mt-1 text-sm text-[var(--text-body)]">Which direction is naturally permitted?</p>
                </div>
                <div className="rounded-xl bg-amber-400/10 p-4">
                  <p className="font-black text-amber-200">Kinetics</p>
                  <p className="mt-1 text-sm text-[var(--text-body)]">How fast does the allowed change occur?</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <Section index="05" title="Equilibrium as the destination of spontaneous change">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <article className="rounded-2xl border border-amber-300/20 bg-amber-300/[0.05] p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-[var(--foreground)]">Temperature differences disappear.</p>
            </article>
            <article className="rounded-2xl border border-cyan-300/20 bg-cyan-300/[0.05] p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-[var(--foreground)]">Unbalanced pressures and forces vanish.</p>
            </article>
            <article className="rounded-2xl border border-violet-300/20 bg-violet-300/[0.05] p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-[var(--foreground)]">No net reaction progress remains.</p>
            </article>
            <article className="rounded-2xl border border-emerald-300/20 bg-emerald-300/[0.05] p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-[var(--foreground)]">No net transfer between stable coexisting phases.</p>
            </article>
          </div>
