      ...
      <article className="mx-auto max-w-5xl space-y-10">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="rounded-xl bg-[var(--background)] p-5 border border-[var(--border)] space-y-3">
              <span className="text-xs font-bold uppercase tracking-widest text-amber-300">Universal Phase &amp; Molar Criteria</span>
              <ul className="list-disc ml-5 space-y-2 text-xs text-[var(--text-body)]">
                <li>
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-xs font-mono">
                <thead>
                  <tr className="border-b border-[var(--border-strong)] bg-[var(--background)]/60 text-[var(--text-body)]">
                    <th className="p-3">Solvent State</th>
                    <th className="p-3">Solute State</th>
                    <th className="p-3">Representative Chemical Examples</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-800 text-[var(--foreground)]">
                  <tr>
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 flex flex-col justify-between">
                <div>
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-4 text-sm leading-relaxed text-[var(--foreground)]">
            <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-5 space-y-3">
              ...
              <p className="text-[var(--text-body)] text-xs leading-relaxed">
              ...
              <div className="border-t border-[var(--border)] pt-3 space-y-2 text-xs font-mono">
                <div className="text-[var(--text-muted)]">Step 1: Calculate total mass of solution</div>
                <BlockMath math={String.raw`m_{\text{solution}} = m_{\text{solute}} + m_{\text{solvent}} = 40 + 160 = 200\text{ g}`} />

                <div className="text-[var(--text-muted)] pt-2">Step 2: Calculate Percentage by Weight (<InlineMath math="\% w/w" />)</div>
                <BlockMath math={String.raw`\% (w/w) = \frac{40}{200} \times 100 = 20\%`} />

                <div className="text-[var(--text-muted)] pt-2">Step 3: Calculate volume of solution using density <InlineMath math="V = \frac{m}{d}" /></div>
                <BlockMath math={String.raw`V_{\text{solution}} = \frac{200\text{ g}}{1.25\text{ g/mL}} = 160\text{ mL}`} />

                <div className="text-[var(--text-muted)] pt-2">Step 4: Calculate Weight-Volume Percentage (<InlineMath math="\% w/v" />)</div>
