...
export default function HeroBlueprint({
  ...
  return (
    <div
      className={`${heightClass} rounded-3xl overflow-hidden relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-[var(--border-strong)] shadow-lg`}
      style={{
    ...
    >
      <div className="absolute inset-0 flex flex-col justify-center items-center p-6 md:p-12 text-center">
        ...
        <p className="text-base md:text-lg text-[var(--text-body)] max-w-2xl">
          {subtitle}
        </p>
      </div>
