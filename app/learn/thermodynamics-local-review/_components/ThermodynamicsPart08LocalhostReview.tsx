    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      {specialCases.map((item) => (
        <article key={item.title} className={`rounded-lg border p-5 ${toneMap[item.tone]}`}>
          ...
          <div className="mt-3 rounded-xl bg-[var(--surface-2)] p-3 text-center font-mono text-sm font-black text-[var(--foreground)]">
            {item.conditions}
          </div>
          <p className="mt-3 font-mono text-base font-semibold text-[var(--foreground)]">{item.result}</p>
          <p className="mt-3 text-xs leading-5 text-[var(--text-muted)]">{item.caution}</p>
        </article>
      ))}
    </div>
  );
    ...
    <div className="overflow-x-auto rounded-lg border border-[var(--border)]">
      <table className="min-w-full border-collapse text-left text-sm">
        <thead className="bg-[var(--surface-2)]">
          <tr>
            <th className="px-4 py-3 font-semibold text-[var(--foreground)]">Transfer viewed from system</th>
            <th className="px-4 py-3 font-semibold text-[var(--foreground)]">System</th>
            <th className="px-4 py-3 font-semibold text-[var(--foreground)]">Surroundings</th>
            <th className="px-4 py-3 font-semibold text-[var(--foreground)]">Combined change from transfer</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-[var(--border)] bg-[var(--surface)]">
          {rows.map(([transfer, system, surroundings, total]) => (
            <tr key={transfer}>
              <td className="px-4 py-3 font-semibold text-[var(--foreground)]">{transfer}</td>
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      <article className="rounded-lg border border-amber-300/20 bg-amber-300/[0.05] p-5">
        <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-amber-300">Heat q</p>
        <div className="mt-4 grid gap-3 text-sm">
          <div className="rounded-xl bg-[var(--surface-2)] p-4">
            <p className="font-semibold text-[var(--foreground)]">Heat enters system</p>
            <p className="mt-1 font-mono text-lg font-black text-emerald-300">q &gt; 0</p>
          </div>
          <div className="rounded-xl bg-[var(--surface-2)] p-4">
            <p className="font-semibold text-[var(--foreground)]">Heat leaves system</p>
      ...
      <article className="rounded-lg border border-cyan-300/20 bg-cyan-300/[0.05] p-5">
        <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-cyan-300">Work w</p>
        <div className="mt-4 grid gap-3 text-sm">
          <div className="rounded-xl bg-[var(--surface-2)] p-4">
            <p className="font-semibold text-[var(--foreground)]">Work done on system</p>
            <p className="mt-1 font-mono text-lg font-black text-emerald-300">w &gt; 0</p>
          </div>
          <div className="rounded-xl bg-[var(--surface-2)] p-4">
            <p className="font-semibold text-[var(--foreground)]">Work done by system</p>
            ...
            <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6">
              ...
              <div className="mt-4 space-y-3">
                <div className="rounded-xl bg-amber-400/10 p-4">
                  ...
                  <p className="mt-1 font-mono font-display text-lg font-semibold text-[var(--foreground)]">q &gt; 0</p>
                </div>
                <div className="rounded-xl bg-cyan-400/10 p-4">
                  <p className="font-black text-cyan-200">Work done on system</p>
                  <p className="mt-1 font-mono font-display text-lg font-semibold text-[var(--foreground)]">w &gt; 0</p>
                </div>
                <div className="rounded-xl bg-emerald-400/10 p-4">
                  <p className="font-black text-emerald-200">Energy balance</p>
                  <p className="mt-1 font-mono font-display text-lg font-semibold text-[var(--foreground)]">ΔU = q + w</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-5 py-9 md:px-8 md:py-12">
        ...
        <Section index="02" title="Thermometer as the third system">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <article className="rounded-lg border border-cyan-300/20 bg-cyan-300/[0.05] p-5">
              <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-cyan-300">Liquid thermometer</p>
              <p className="mt-2 text-sm leading-6 text-[var(--text-body)]">Thermometric property: liquid volume or column length.</p>
            </article>
            <article className="rounded-lg border border-violet-300/20 bg-violet-300/[0.05] p-5">
              <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-violet-300">Resistance thermometer</p>
              <p className="mt-2 text-sm leading-6 text-[var(--text-body)]">Thermometric property: electrical resistance.</p>
            </article>
            <article className="rounded-lg border border-amber-300/20 bg-amber-300/[0.05] p-5">
              <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-amber-300">Gas thermometer</p>
              <p className="mt-2 text-sm leading-6 text-[var(--text-body)]">Thermometric property: gas pressure or volume under controlled conditions.</p>
            </article>
          </div>
        ...
        <Section index="10" title="Closed, isolated and open-system energy balances">
          <div className="grid gap-4 lg:grid-cols-3">
            <article className="rounded-lg border border-cyan-300/20 bg-cyan-300/[0.05] p-5">
              ...
              <div className="mt-4 rounded-xl bg-[var(--surface-2)] p-3 text-center font-mono font-semibold text-[var(--foreground)]">
                ΔU = q + w
              </div>
            </article>
        ...
        <Section index="11" title="What the First Law cannot tell us">
          <div className="grid gap-4 md:grid-cols-2">
            <article className="rounded-lg border border-emerald-300/20 bg-emerald-300/[0.05] p-5">
              <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-emerald-300">It can determine</p>
            ...
            <article className="rounded-lg border border-rose-300/20 bg-rose-300/[0.05] p-5">
              <p className="font-mono text-xs font-semibold uppercase tracking-[0.18em] text-rose-300">It cannot determine alone</p>
              <ul className="mt-3 space-y-2 text-sm leading-6 text-[var(--text-body)]">
