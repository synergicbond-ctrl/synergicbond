...
import ThermodynamicsPart10LocalhostReview from "../_components/ThermodynamicsPart10LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 10 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 10.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart10LocalhostReview />
