    ...
    <AtomicPartShell part={35} title="Schrödinger Wave Equation — Wave Function and Wave Equation" pages="109-112">
      ...
      <SourcePage page={110}>
        <ConceptCard title="Why a wave packet needs a function">
          ...
          <figure className="mt-4 rounded-lg border border-cyan-400/20 bg-cyan-400/[0.04] p-4"><WavePacketVisual /><figcaption className="mt-3 text-sm text-slate-300">This is a localisation sketch; it does not replace the stated properties of Ψ below.</figcaption></figure>
        </ConceptCard>
