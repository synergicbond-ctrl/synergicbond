...
import ThermodynamicsPart12LocalhostReview from "../_components/ThermodynamicsPart12LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 12 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 12.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart12LocalhostReview />

      <nav className="border-t border-white/10 bg-[#020617] px-5 py-10 text-slate-100">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          <Link
            href="/learn/thermodynamics-local-review/part11"
          ...
          <Link
            href="/learn/thermodynamics-local-review/part13"
