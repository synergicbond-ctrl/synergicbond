...
export default function DBlockPart07() {
  return (
    <AppShell
      ...
      chapterSlug="d-block"
      description="A solid-state account of substitutional alloys, interstitial carbides and hydrides, vacancy compensation in Fe₁₋ₓO, defect-controlled colour and conductivity, and the highly uneven geochemical abundance of transition elements."
      free={false}
