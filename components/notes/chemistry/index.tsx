...
export function NotesChapterHeader({
  ...
  return (
    <header className="rounded-2xl border border-purple-500/20 bg-slate-900/40 p-6 sm:p-8 space-y-5 backdrop-blur-md relative overflow-hidden">
      {/* Decorative Glow */}
...
export function QuestionCard({
  ...
  return (
    <div className={`border-l-4 border-rose-400 bg-[rgba(251,113,133,0.06)] p-5 my-4 space-y-2 text-slate-100 ${className}`}>
...
export function FinalAnswerCard({
  ...
  return (
    <div className={`border-l-4 border-emerald-400 bg-[rgba(52,211,153,0.10)] p-4 my-3.5 font-bold text-emerald-100 flex items-start sm:items-center gap-2.5 ${className}`}>
...
export function ImportantNoteCard({
  ...
  return (
    <div className={`border-l-4 border-amber-400 bg-[rgba(251,191,36,0.06)] p-5 my-4 space-y-2.5 text-amber-200 ${className}`}>
      {title && (
...
export function WarningCard({
  ...
  return (
    <div className={`border-l-4 border-rose-400 bg-[rgba(251,113,133,0.06)] p-5 my-4 space-y-2.5 text-rose-200 ${className}`}>
      {title && (
        <div className="font-bold text-rose-200 flex items-center gap-1.5 text-sm uppercase tracking-wider">
          <span>⚠️</span> {title}
        </div>
      )}
      <div className="space-y-2 leading-relaxed">{children}</div>
