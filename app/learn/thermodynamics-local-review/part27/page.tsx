...
import ThermodynamicsPart27LocalhostReview from "../_components/ThermodynamicsPart27LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 27 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 27.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart27LocalhostReview />
