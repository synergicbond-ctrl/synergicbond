...
function Fischer({ n }: { n: number }) {
  ...
  return <svg viewBox="0 0 165 190" className={svgClass} role="img" aria-label={`source Fischer projection ${n}`}>
