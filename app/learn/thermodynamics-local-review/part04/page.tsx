...
import ThermodynamicsPart04LocalhostReview from "../_components/ThermodynamicsPart04LocalhostReview";

export const metadata = {
  title: "Thermodynamics Part 04 Local Review | Synergic Bond",
  description: "Private localhost review of Thermodynamics Part 04.",
};
...
export default function Page() {
  return (
    <>
      ...
      <ThermodynamicsPart04LocalhostReview />
